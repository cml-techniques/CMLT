<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Summary.aspx.cs" Inherits="CmlTechniques.CMS.Summary" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                <ContentTemplate>
                                    <asp:DropDownList ID="drtype" runat="server" Width="100%" OnSelectedIndexChanged="drtype_SelectedIndexChanged">
