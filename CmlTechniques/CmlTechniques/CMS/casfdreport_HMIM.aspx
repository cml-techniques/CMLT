<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casfdreport_HMIM.aspx.cs" Inherits="CmlTechniques.CMS.casfdreport_HMIM" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    <form id="form1" runat="server">
     <div style="font-family: verdana; font-size: xx-small;width:100%">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2664px;height:80px" cellspacing="1" border="0" id="headTbl" runat="server">
