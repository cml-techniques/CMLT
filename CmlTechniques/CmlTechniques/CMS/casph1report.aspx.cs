...
{
    public partial class casph1report : System.Web.UI.Page
    {
        ...
        {
            if (lblprj.Text == "11736" && lblsch.Text == "24")
        ...
        protected void print_Click(object sender, EventArgs e)
        {
             ...
             if (lblprj.Text == "11784" && !string.IsNullOrEmpty(lblsch.Text))
            {
             ...
             _path = "Cas_Report.aspx?id=17_P" + lblprj.Text + "_B" + drbuilding.SelectedItem.Value + "_F" + drflevel.SelectedItem.Value + "_C" + drcategory.SelectedItem.Value + "_D" + drfed.SelectedItem.Value + "_Z" + (string)Session["zero"] + "&Div=" + lbldiv.Text;
