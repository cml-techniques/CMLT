<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casmv1report.aspx.cs" Inherits="CmlTechniques.CMS.casmv1report" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3897px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" colspan="10">PANEL/EQUIPMENT SITE TESTING</td>
        <td align="center" colspan="5">MV CABLE TEST</td>
        ...
        <td style="width:100px" align="center">HV TEST</td>
        <td style="width:100px" align="center">PRIMARY INJECTION TEST</td>
        <td style="width:100px" align="center">CONTACT RESISTANCE</td>
        <td style="width:100px" align="center">PT TEST</td>
        <td style="width:100px" align="center">CT TEST</td>
        <td style="width:100px" align="center">RELAY TEST</td>
        <td style="width:100px" align="center">FUNCTIONAL TEST</td>
        <td style="width:100px" align="center">SITE PANEL TEST PROGRESS</td>
        <td style="width:100px" align="center">TOTAL NO.OF CIRCUIT</td>
        <td style="width:100px" align="center">CONTINUITY/IR/ HI POT TEST</td>
        <td style="width:100px" align="center">DATE TESTED</td>
        <td style="width:100px" align="center">MV CABLE TEST % COMPLETE</td>
        <td style="width:100px" align="center">WITNESSED BY</td>
        </tr>
        <tr bgcolor="#092443">
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="F_from">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("per_com6")+ "%"  %>' Width="100px" ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:TemplateField HeaderText="PANEL" HeaderStyle-Font-Bold="false">
                 ...
                 <asp:TemplateField HeaderText="MV CABLE TESTS" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
