<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casfavareport_pcd.aspx.cs" Inherits="CmlTechniques.CMS.casfavareport_pcd" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div  style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold"><asp:Label ID="lblhead" runat="server" Text="CAS CAS ELV1 Fire Alarm & Voice Evacuation Commissioning Activity Schedule"></asp:Label></td>
                ...
                <asp:Label ID="lblsch" runat="server" Text="" style="display:none"></asp:Label> <asp:Label ID="lbldiv" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv" >
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3591px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">CONTINUITY/ IR PLANNED</td>
        <td style="width:100px" align="center" rowspan="2">CONTINUITY/IR TESTED</td>
        <td style="width:100px" align="center" rowspan="2">NO.OF DEVICES</td>
        <td style="width:100px" align="center" rowspan="2">DEVICE TEST PLANNED</td>
        <td style="width:100px" align="center" rowspan="2">NO.OF DEVICES TESTED</td>
        <td style="width:100px" align="center" rowspan="2">DEVICE TEST COMPLETE</td>
        <td style="width:100px" align="center" rowspan="2">NO.OF INTERFACES</td>
        <td style="width:100px" align="center" rowspan="2">INTERFACE TEST PLANNED</td>
        <td style="width:100px" align="center" rowspan="2">FA INTERFACES TESTED</td>
        <td style="width:100px" align="center" rowspan="2">LOOP TEST COMPLETE</td>
        <td align="center" colspan="2">COMMISSIONING &amp; TESTING</td>
        <td align="center" rowspan="2">SOUND LEVEL  PLANNED</td>
        <td align="center" rowspan="2">SOUND LEVEL TEST</td>
        <td align="center" rowspan="2">BATTERY AUTONOMY PLANNED</td>
          <td align="center" rowspan="2">BATTERY AUTONOMY TEST</td>
        <td align="center" rowspan="2">GRAPHIC/HEAD END PLANNED</td>
           <td align="center" rowspan="2">GRAPHIC/HEAD END TEST</td>
        <td align="center" rowspan="2">CAUSE &amp; EFFECT  PLANNED</td>
        <td align="center" rowspan="2">CAUSE &amp; EFFECT TESTS</td>
        ...
        <div style="position:relative;float:left;width:3591px">
            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
            <ContentTemplate>
            <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" 
                Width="3591px" onrowdatabound="mymaster_RowDataBound" 
                Font-Names="Verdana" 
                    Font-Size="X-Small" ShowHeader="False" GridLines="None" >
            <Columns>
            <asp:TemplateField>
            <ItemTemplate>
            <table id="inner_table" width="3591px">
            <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
            <td style="width:50px">
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="Loc" >
                    ...
                    <asp:BoundField DataField="devices2" >
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
...
<asp:BoundField DataField="PCDate3" >
                    ...
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                       ...
                       <asp:BoundField DataField="PCDate4" >
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="test7" >
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
                     <asp:BoundField DataField="PCDate5" >
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="test11" >
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
                     <asp:BoundField DataField="PCDate6" >
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
                    ...
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                     ...
                     <asp:BoundField DataField="test8" > </asp:BoundField>  
                      <asp:BoundField DataField="test9" > </asp:BoundField>  
                    <asp:BoundField DataField="tested1" > </asp:BoundField>  
                    <asp:BoundField DataField="tested2" > </asp:BoundField>  
                    <asp:BoundField DataField="test12" > </asp:BoundField>  
                    <asp:BoundField DataField="test13" > </asp:BoundField> 
                    <asp:BoundField DataField="test14" > </asp:BoundField>  
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField ="QTY" HeaderText="QUANTITY" HeaderStyle-Font-Bold="false" > 
                    ...
                    <asp:BoundField DataField ="QTY_PLANNED" HeaderText="QUANTITY PLANNED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                <asp:BoundField DataField ="PER_COMPLETED" HeaderText="NO.OF TESTED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                    <asp:BoundField DataField ="TOTAL_PLANNED" HeaderText="PLANNED OVERALL PROGRESS" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
