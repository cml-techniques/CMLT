<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casbms1report.aspx.cs" Inherits="CmlTechniques.CMS.casbms1report" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.2.2 Energy Management and Control System (EMCS) Commissioning Activity Schedule</td>
                    </tr>
                </table>
        ...
        <td style="width:200px" align="center" rowspan="2">SYSTEMS MONITORED/ NO.OF 
            EQUIPMENTS</td>
