...
{
    public partial class casgenreport : System.Web.UI.Page
    {
        [Serializable]
        ...
        private void Load_Master() 
        {
            ...
            if (lblprj.Text == "11784" && (Request.QueryString["sch"] != null))
            {
                ...
                if (Request.QueryString["sch"].ToString() == "27")
                {
        ...
        {
            info1.AddMergedColumns(new int[] { 3,4, 5 }, "GENERATOR TEST PROGRESS");
        }
        ...
        protected void mygridsumm_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblprj.Text == "ASAO" || lblprj.Text == "ASAO1")
                {
                    ...
                    _tested3 += Convert.ToDecimal(e.Row.Cells[12].Text);
                    _sumry += (Convert.ToDecimal(e.Row.Cells[13].Text) * Convert.ToDecimal(e.Row.Cells[2].Text));
                }
                else
                {
                    _tested1 += Convert.ToDecimal(e.Row.Cells[10].Text);
                    _tested2 += Convert.ToDecimal(e.Row.Cells[11].Text);
                    _tested3 += Convert.ToDecimal(e.Row.Cells[12].Text);
                    _total += Convert.ToDecimal(e.Row.Cells[13].Text);
                }
                _count += 1;
            }
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                if (lblprj.Text == "ASAO" || lblprj.Text == "ASAO1")
                {
                    //_total = Decimal.Round((((_tested1 * 0.6m) + (_tested2 * 0.1m) + (_tested3 * 0.3m)) / _qty) * 100);
                    e.Row.Cells[6].Text = Decimal.Round(_tested1).ToString();
                    e.Row.Cells[7].Text = Decimal.Round(_tested2).ToString();
                    e.Row.Cells[8].Text = Decimal.Round(_tested3).ToString();
                    e.Row.Cells[9].Text = Decimal.Round(_sumry/_qty).ToString() + '%';
                }
                else
                {
                    e.Row.Cells[3].Text = (Decimal.Round((_tested1 / _count))).ToString() + '%';
                    e.Row.Cells[4].Text = (Decimal.Round((_tested2 / _count))).ToString() + '%';
        ...
        protected void print_Click(object sender, EventArgs e)
        {
            ...
            _path = "Cas_Report.aspx?id=4_P" + lblprj.Text + "_B" + drbuilding.SelectedItem.Value + "_F" + drflevel.SelectedItem.Value + "_C" + drcategory.SelectedItem.Value + "_D" + drfed.SelectedItem.Value + "_Z" + (string)Session["zero"] + "&Div=" + lbldiv.Text; ;
