<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="caselpreport.aspx.cs" Inherits="CmlTechniques.CMS.caselpreport" ValidateRequest="false" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">CAS E3 ELECTRICAL SERVICES.EARTHING &amp; LIGHTNING COMMISSIONING ACTIVITY SCHEDULE</td>
                    </tr>
                </table>
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text="CAS E3 Electrical Services.Earthing & Lightning Protection Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2945px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <div style="position:relative;float:left;width:2945px">
            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
            <ContentTemplate>
            <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" 
                Width="2945px" onrowdatabound="mymaster_RowDataBound" 
                Font-Names="Verdana" 
                    Font-Size="X-Small" ShowHeader="False" GridLines="None" >
            <Columns>
            <asp:TemplateField>
            <ItemTemplate>
            <table id="inner_table" width="2945px">
            <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
            <td style="width:50px">
...
<HeaderStyle Font-Bold="False"></HeaderStyle>
                 ...
                 <asp:BoundField DataField="P_P_to" HeaderText="PROVIDES EARTHING/ LIGHTNING PROTECTION TO" ItemStyle-Width="150px" HeaderStyle-Font-Bold="false"  >
<HeaderStyle Font-Bold="False"></HeaderStyle>

                    <ItemStyle Width="150px" />
                    </asp:BoundField>
                    
                    <asp:BoundField DataField="test1" HeaderText="EARTH PIT TEST" ItemStyle-Width="150px" HeaderStyle-Font-Bold="false"  >
<HeaderStyle Font-Bold="False"></HeaderStyle>

                    <ItemStyle Width="150px" HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="test2" HeaderText="CONSUL. ACCEPTED" ItemStyle-Width="100px" HeaderStyle-Font-Bold="false"  >
<HeaderStyle Font-Bold="False"></HeaderStyle>

                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="test3" HeaderText="TEST SHEET FILED" ItemStyle-Width="100px" HeaderStyle-Font-Bold="false"  >
<HeaderStyle Font-Bold="False"></HeaderStyle>

                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="test6" HeaderText="(EARTHING) BONDING OF ALL EQUIP. COMPL." ItemStyle-Width="150px" HeaderStyle-Font-Bold="false" >
<HeaderStyle Font-Bold="False"></HeaderStyle>

                    <ItemStyle Width="150px" HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="accept1" HeaderText="CONSUL. ACCEPTED" ItemStyle-Width="100px" HeaderStyle-Font-Bold="false"  >
<HeaderStyle Font-Bold="False"></HeaderStyle>
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
...
<HeaderStyle Font-Bold="False"></HeaderStyle>
                    ...
                    <asp:BoundField DataField="devices1" HeaderText="LIGHTNING PROTECTION PIT TEST" ItemStyle-Width="150px" HeaderStyle-Font-Bold="false"  >
<HeaderStyle Font-Bold="False"></HeaderStyle>

                    <ItemStyle Width="150px" HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="tested1" HeaderText="CONSULT. ACCEPTED" ItemStyle-Width="100px" HeaderStyle-Font-Bold="false"  >
<HeaderStyle Font-Bold="False"></HeaderStyle>

                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="test8" HeaderText="TEST SHEET FILED" ItemStyle-Width="100px" HeaderStyle-Font-Bold="false"  >
<HeaderStyle Font-Bold="False"></HeaderStyle>

                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
                     <asp:BoundField DataField="test10" HeaderText="(LIGHTNING) BONDING OF ROOF EQUIP.& DOWN CONDU. TEST COMPLETE " ItemStyle-Width="150px" HeaderStyle-Font-Bold="false"  >
<HeaderStyle Font-Bold="False"></HeaderStyle>
...
<HeaderStyle Font-Bold="False"></HeaderStyle>
        ...
        <div>
            ...
            <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:TemplateField HeaderText="EARTH PIT TEST" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                 ...
                 <asp:TemplateField HeaderText="BONDING TEST" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
