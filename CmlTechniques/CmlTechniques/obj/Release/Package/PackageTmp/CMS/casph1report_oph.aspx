<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casph1report_oph.aspx.cs" Inherits="CmlTechniques.CMS.casph1report_oph" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
       ...
       <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;width:100%;height:26px">
        ...
        <td style="font-weight: bold">
            <asp:Label ID="lblhead" runat="server" Text="CAS PH1 Public Health Services Commissioning Activity Schedule"></asp:Label></td>
        </tr>
        </table>
        <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label><asp:Label ID="lbldiv" runat="server" Text="" CssClass="hidden"></asp:Label><asp:Label ID="lblsch" runat="server" Text="" CssClass="hidden"></asp:Label>
        </div>
        <div id="HeaderDiv" >
        ...
        <td align="center" colspan="7">COMMISSIONING &amp; ACCEPTANCE</td>
        ...
        <td style="width:100px" align="center">PRE-COMM PLANNED</td>
        <td style="width:100px" align="center">PRE-COMM</td>
        <td style="width:100px" align="center">COMM-PLANNED</td>
        ...
        <div style="position:relative;float:left;width:2770px">
            ...
            <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" 
                Width="2770px" onrowdatabound="mymaster_RowDataBound" 
                Font-Names="Verdana" 
        ...
        <div>  
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowdatabound="mygridsumm_RowDataBound" ShowFooter="true">
                ...
                <asp:TemplateField HeaderText="TOTAL NO. PRE-COMMISSIONED" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                 ...
                 <asp:TemplateField HeaderText="TOTAL NO. COMMISSIONED" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
