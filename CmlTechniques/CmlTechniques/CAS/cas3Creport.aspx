<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas3Creport.aspx.cs" Inherits="CmlTechniques.CAS.cas3Creport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.2.1 - Fire Alarm and Fire Telephone Communication System Commissioning Activity Schedule</td>
                    </tr>
                </table>
        
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3032px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">LOOP CIRCUIT NUMBER</td>
        <td style="width:100px" align="center" rowspan="2">LOCATION</td>
        ...
        <td style="width:100px" align="center" rowspan="2">ENERGISATION/ PROGRAMMING&nbsp;</td>
        <td style="width:100px" align="center" rowspan="2">NO.OF DEVICES PER LOOP/PANEL</td>
        <td align="center" colspan="2">CABLE TEST</td>
        <td align="center" colspan="2">DEVICE TEST</td>
        <td align="center" colspan="2">INTERFACE TESTING</td>
        <td align="center" rowspan="2">BATTERY AUTONOMY TEST</td>
        <td align="center" rowspan="2">GRAPHICS/ HEAD END TEST</td>
        <td align="center" colspan="2">FINAL TEST SHEETS</td>
        <td style="width:100px" align="center" rowspan="2">FPT SIGN OFF [CML]</td>
        <td style="width:150px" align="center" rowspan="2">ACCEPTANCE RECOMMENDATION<br /> MADE</td>
        ...
        <td style="width:100px" align="center">NO.OF CABLE TESTED</td>
        <td style="width:100px" align="center">DATE TESTED</td>
        <td style="width:100px" align="center">NO.OF DEVICES TESTED</td>
        <td style="width:100px" align="center">DEVICE TEST COMPLETE</td>
        <td style="width:100px" align="center">NO.OF INTERFACES</td>
        <td style="width:100px" align="center">FA INTERFACES TESTED</td>
        ...
        <td style="width:100px" align="left"><asp:UpdatePanel ID="UpdatePanel17" runat="server">
                 <ContentTemplate>
        ...
        <div style="position:relative;float:left;width:3032px">
        ...
        <div >
            ...
            <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField ="QTY1" HeaderText="QTY" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="TESTED" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("TESTED1")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField ="QTY2" HeaderText="QTY" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                <asp:TemplateField HeaderText="TESTED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("TESTED2")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>  
                    <asp:BoundField DataField ="QTY3" HeaderText="QTY" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                <asp:TemplateField HeaderText="TESTED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("TESTED3")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField> 
                    <asp:BoundField DataField ="QTY4" HeaderText="QTY" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                <asp:TemplateField HeaderText="TESTED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("TESTED4")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
                ...
                <asp:BoundField DataField ="TESTED" HeaderText="TESTED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                 <asp:TemplateField HeaderText="T&C %  COMPLETE" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                    ...
                    <asp:BoundField DataField="T1" />
                    <asp:BoundField DataField="T2" />
                    <asp:BoundField DataField="T3" />
                    <asp:BoundField DataField="T4" />
              </Columns>
            </asp:GridView>
            </ContentTemplate>
            </asp:UpdatePanel>
