<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casph2report_MOE.aspx.cs" Inherits="CmlTechniques.CMS.casph2report_MOE" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
     <div style="font-family: verdana; font-size: xx-small">
       ...
       <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;width:100%;height:26px">
        ...
        <td align="center" colspan="2">FIRE HYDRANT</td>
        <td align="center" colspan="2">ZONE CONTROL VALVES</td>
        <td align="center" colspan="2">MONITORED VALVES</td>
        <td align="center" colspan="2">FIRE HOSE CABINET</td>
