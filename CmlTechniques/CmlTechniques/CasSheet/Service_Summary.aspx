<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Service_Summary.aspx.cs" Inherits="CmlTechniques.CasSheet.Service_Summary"  %>
...
<body>
    ...
    <div>
        ...
        <asp:UpdatePanel ID="UpdatePanel8" runat="server">
            ...
            HasToggleGroupTreeButton="False" HasViewList="False" ToolbarStyle-Width="100%" Width="100%" />--%>
                <%--<CR:CrystalReportViewer ID="CrystalReportViewer2" runat="server" AutoDataBind="true" DisplayGroupTree="False" HasCrystalLogo="False" 
            HasToggleGroupTreeButton="False" HasViewList="False" ToolbarStyle-Width="100%" Width="100%">
