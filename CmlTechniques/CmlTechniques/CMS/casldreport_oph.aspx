<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casldreport_oph.aspx.cs" Inherits="CmlTechniques.CMS.casldreport_oph" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
   ...
   <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2305px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">NO OF PROTECTION/ DETECTION</td>
        <td style="width:100px" align="center" rowspan="2">PLANNED COMPLETION DATE</td>
        <td style="width:100px" align="center" rowspan="2">CONTINUITY TEST</td>
        <td style="width:100px" align="center" rowspan="2">PROGRAMMING AND COMMUNICATION 
            TEST</td>
        <td style="width:100px" align="center" rowspan="2">COMMISSIONING</td>
        ...
        <div >
            ...
            <br />
           <h2 style="margin:0">Summary of LDS Commissioning &amp; Testing </h2>
            <div>
            <div >
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:BoundField DataField="SYS_NAME" HeaderText="EQUIPMENTS" HeaderStyle-Font-Bold="false" >
                    ...
                    <asp:BoundField DataField="QTY" HeaderText="NO. OF POINTS/ DETECTION" HeaderStyle-Font-Bold="false" >
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                    <asp:BoundField DataField ="PER_COMPLETED" HeaderText="CONTINUITY TEST" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="150px" />
                    </asp:BoundField>
                     <asp:BoundField DataField ="PER_COMPLETED1" HeaderText="PROGRAMMING & COMMUNICATION TEST" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="150px" />
                    </asp:BoundField>
                 <asp:BoundField DataField ="PER_COMPLETED2" HeaderText="COMMISSIOINING" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="150px" />
                    </asp:BoundField>
