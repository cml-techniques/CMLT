<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casfdreport.aspx.cs" Inherits="CmlTechniques.CMS.casfdreport" ValidateRequest="false" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    <form id="form1" runat="server">
     <div style="font-family: verdana; font-size: xx-small;width:100%">
        ...
        <table>
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text="CAS M3 Fusible Link Fire Dampers & MSFD Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2564px;height:80px" cellspacing="1" border="0" id="headTbl" runat="server">
        ...
        <td style="width:100px" align="center" rowspan="2" id="td_icom1" runat="server">INSTALLATION COMPLETION SIGN OFF</td>
        <td align="center" colspan="3">FUSIBLE LINK FIRE DAMPERS</td>
        <td align="center" colspan="4">MOTORISED SMOKE FIRE DAMPERS</td>
        ...
        <td style="width:100px" align="center">ACCESSIBILITY ACCEPTABLE</td>
        <td style="width:100px" align="center">DROP TEST PASSED</td>
        <td style="width:100px" align="center">RESET PASSED</td>
        <td style="width:100px" align="center">MANUEL OPEN OPERATION</td>
        <td style="width:100px" align="center">SPRING RETURN OPERATION</td>
        <td style="width:100px" align="center">END SWITCH TEST</td>
        <td style="width:100px" align="center">POWER OPEN/ SPRING RETURN TEST</td>
        <td style="width:100px" align="center">CONSULTANT ACCEPTED</td>
        <td style="width:100px" align="center">TEST SHEETS FILED</td>
        </tr>
        <tr bgcolor="#092443">
        <td align="center"><asp:UpdatePanel ID="UpdatePanel16" runat="server">
                 <ContentTemplate>
        ...
        <td align="center" id="td_icom2" runat="server">
            &nbsp;</td>
        <td align="center"></td>
        <td align="center"></td>
        <td align="center"></td>
        ...
        <div style="position:relative;float:left;width:2564px">
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                Font-Names="Verdana" 
                Font-Size="X-Small" ShowHeader="false" Width="100%" >
                <Columns>
                <asp:BoundField>
        ...
        <div>  
            ...
            <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" 
               ...
               <asp:TemplateField HeaderText="TOTAL PRE - COMMISSIONED" HeaderStyle-Font-Bold="false">
                 ...
                 <asp:TemplateField HeaderText="SATISFACTORILY TESTED" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                 ...
                 <asp:TemplateField HeaderText="WITNESSED" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
