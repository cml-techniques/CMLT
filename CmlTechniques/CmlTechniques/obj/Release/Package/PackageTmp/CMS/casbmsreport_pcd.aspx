<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casbmsreport_pcd.aspx.cs" Inherits="CmlTechniques.CMS.casbmsreport_pcd" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
     ...
     <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;height:26px">
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                        <asp:Label ID="lblhead" runat="server" Text="CAS ELV2 ELV Services | BMS Commissioning Activity Schedule"></asp:Label>
                                                   <td>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3879px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:150px" align="center" rowspan="2">SYSTEMS CONTROLLED/ MONITORED BY 
            DDC</td>
        <td style="width:150px" align="center" rowspan="2">FED FROM</td>
        <td style="width:100px" align="center" rowspan="2">TOTAL NO.OF POINTS</td>
        <td style="width:100px" align="center" rowspan="2">NO.OF DEVICES REQ&#39;D CALIBRATION</td>
        <td style="width:100px" align="center" rowspan="2">NO.OF SYSTEM REQUIRED LOOP TUNING</td>
        <td align="center" colspan="18">COMMISSIONING &amp; TESTING</td>
        ...
        <td style="width:100px" align="center">SEQ. NO</td>
          <td style="width:100px" align="center">PLANNED CONTINUITY/IR TESTED</td>
        <td style="width:100px" align="center">CONTINUITY/IR TESTED</td>
        <td style="width:100px" align="center">PLANNED POINT TO POINT TEST</td>
        <td style="width:100px" align="center">POINT TO POINT TEST</td>
        <td style="width:100px" align="center">PLANNED CALIBRATION/ FUNCTIONAL TEST</td>
        <td style="width:100px" align="center">CALIBRATION/ FUNCTIONAL TEST</td>
        <td style="width:100px" align="center">CONSULTANT ACCEPTED</td>
        <td style="width:100px" align="center">TEST SHEETS FILED</td>
        <td style="width:100px" align="center">PLANNED SEQUENCE OF OPERATION TEST</td>
         <td style="width:100px" align="center">SEQUENCE OF OPERATION TEST</td>
        <td style="width:100px" align="center">PLANNED GRAPHICS/ HEAD END TEST</td>
        <td style="width:100px" align="center">GRAPHICS/ HEAD END TEST</td>
        <td style="width:100px" align="center">CONSULTANT ACCEPTED</td>
        <td style="width:100px" align="center">TEST SHEETS FILED</td>
        <td style="width:100px" align="center">PLANNED LOOP TUNING</td>
        <td style="width:100px" align="center">LOOP TUNING</td>
        <td style="width:100px" align="center">CONSULTANT ACCEPTED</td>
        <td style="width:100px" align="center">TEST SHEETS FILED</td>
        </tr>
        <tr bgcolor="#092443">
        ...
        <div style="position:relative;float:left;width:3879px">
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="devices3" >
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
             ...
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField ="QTY" HeaderText="QUANTITY" HeaderStyle-Font-Bold="false" > 
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                      ...
                      <asp:BoundField DataField ="QTY_PLANNED" HeaderText="PLANNED NO. OF POINTS TESTED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
