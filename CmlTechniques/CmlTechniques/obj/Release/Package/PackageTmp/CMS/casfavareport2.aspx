<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casfavareport2.aspx.cs" Inherits="CmlTechniques.CMS.casfavareport2" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div  style="font-family: verdana; font-size: xx-small">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2979px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">INTERFACE/ EQUIPMENT TEST</td>
