<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="castrans2report.aspx.cs" Inherits="CmlTechniques.CMS.castrans2report" %>
...
<body  onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    <form id="form1" runat="server">
     <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">CAS E2 Electrical Services. HV & MV Transformers Commissioning Activity Schedule</td>
                    </tr>
                </table>
        ...
        <td align="center" colspan="9">TRANSFORMER TESTING</td>
        ...
        <td style="width:100px" align="center">MAGNETIC CORE BALANCE TEST</td>
        <td style="width:100px" align="center">MAGNETIZING CURRENT TEST</td>
            ...
            <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:TemplateField HeaderText="TRANSFORMER" HeaderStyle-Font-Bold="false">
                 ...
                 <asp:TemplateField HeaderText="CABLE" HeaderStyle-Font-Bold="false">
                    ...
                    <asp:BoundField DataField ="PER_COMPLETED" HeaderText="TRANSFORMER" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
