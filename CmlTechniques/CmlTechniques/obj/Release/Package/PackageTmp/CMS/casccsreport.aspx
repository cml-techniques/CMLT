<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casccsreport.aspx.cs" Inherits="CmlTechniques.CMS.casccsreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small;width:100%">
        ...
        <td style="width:100px" align="center" rowspan="2">NO.OF VALVE SETS</td>
        ...
        <td style="width:100px" align="center">INSTALLATION &amp; DOCUMENTATION COMPLETED</td>
        <td style="width:100px" align="center">PRE-COM</td>
        <td style="width:100px" align="center">COMM</td>
        <td style="width:100px" align="center">% DUTY</td>
             ...
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:TemplateField HeaderText="TOTAL PRE-COMMISSIONED" HeaderStyle-Font-Bold="false">
                 ...
                 <asp:TemplateField HeaderText="TOTAL COMMISSIONED" HeaderStyle-Font-Bold="false">
                    ...
                    <asp:TemplateField HeaderText="ENGINEER ACCEPTED" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
