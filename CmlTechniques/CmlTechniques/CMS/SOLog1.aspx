<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SOLog1.aspx.cs" Inherits="CmlTechniques.CMS.SOLog1" %>
...
<body>
    ...
    <div style="font-family: verdana; font-size: x-small;height:100%;width:100%">
        ...
        <tr>
        <td style="width:110px">Service</td>
        <td style="width:110px"><asp:DropDownList ID="soservice" runat="server" 
                Width="200px"></asp:DropDownList></td>
        <td style="width:110px">&nbsp;</td>
        <td style="width:300px">&nbsp;</td>
        <td style="width:110px">&nbsp;</td>
        <td style="width:250px">
        <%--<asp:DropDownList ID="soissuedto" runat="server" Width="250px"></asp:DropDownList>--%></td>
        <td>
        ...
        <td style="font-size: xx-large; font-weight: bold;">SO</td>
        <td style="width:40px" align="center">
            <asp:UpdatePanel ID="UpdatePanel10" runat="server">
            <ContentTemplate>
                <asp:Button ID="btnprint" runat="server" Text="" 
                    style="background:url('../images/print_icon.png');cursor:pointer" 
                    BorderStyle="None" Height="30px" width="30px" onclick="btnprint_Click"/>
            </ContentTemplate>
            </asp:UpdatePanel>
                        </td>
        </tr>
        ...
        <%--<p style="margin:0; background-color: #092443; color: #FFFFFF;height:30px"><span style="font-size:x-large;font-weight:bold">Document Review</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Document Name" Height="20px"></asp:Label>&nbsp; <asp:TextBox ID="txtreviewed" runat="server" Width="300px"></asp:TextBox>&nbsp;<asp:Label 
                ID="Label2" runat="server" Text="Issued to" Height="20px"></asp:Label>&nbsp;<asp:DropDownList ID="soissuedto" runat="server" Width="300px">
        ...
        <div style="height:100%">
            ...
            <%--<asp:GridView ID="mygrid" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                <asp:BoundField DataField="so_no" HeaderText="DR.NO" />
                <asp:ButtonField DataTextField="so_no" HeaderText="DR.NO" ButtonType="Button" >
                    <ControlStyle Font-Size="X-Small" Height="20px" Width="50px" />
                    <ItemStyle Width="50px" />
                    </asp:ButtonField>
                <asp:BoundField DataField="so_reviewed" HeaderText="DOCUMENT REVIEWED" />
                ...
                <asp:BoundField DataField="so_status" HeaderText="STATUS" >
            ...
            <td style="width:6%;height:30px" align="center">SO.NO</td>
            <td style="width:8%" align="center">SERVICE</td>
            <td style="width:15%" align="center">SUBJECT</td>
            <td style="width:7%" align="center">ISSUED DATE</td>
            <td style="width:13%" align="center">REVIEWED BY</td>
            <td style="width:13%" align="center">ISSUED TO</td>
            <td style="width:12%" align="center">COMMENTS</td>
            <td style="width:12%" align="center">RESPONSE</td>
            <td style="width:6%" align="center">STATUS</td>
            ...
            <td style="width:5%" align="center"></td>
                ...
                <tr style="background-color:#092443">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="so_service" runat="server" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="so_service_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </ContentTemplate>
                                            </asp:UpdatePanel>
                    </td>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="soreview" runat="server" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="soreview_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </ContentTemplate>
                                            </asp:UpdatePanel>
                    </td>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="soissue" runat="server" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="soissue_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </ContentTemplate>
                                            </asp:UpdatePanel>
                    </td>
                    ...
                    <td align="center" style="width:6%">
                     <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="sostatus" runat="server" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="sostatus_SelectedIndexChanged">
            ...
            <%--<asp:ListView ID="myview" runat="server" 
                ...
                <ItemTemplate>
                    <tr  id="itm_tr" runat="server">
                        <td style="width:60px">
                            ...
                            <asp:Button ID="btnso_no" runat="server" Text='<%# Eval("so_no") %>' CommandName="select" Width="60px" />
                        ...
                        <td style="width:250px">
                            <asp:Label ID="so_reviewedLabel" runat="server" 
                                Text='<%# Eval("so_reviewed") %>' Width="250px" />
                        </td>
                  ...
                  <asp:Label ID="lbdate" runat="server" Text='<%# Eval("issue_date") %>' style="display:none"  />
                        ...
                        <asp:Label ID="so_statusLabel" runat="server" Text='<%# Eval("so_status") %>' Width="50px" />
                ...
                <InsertItemTemplate>
                    <tr style="">
                        ...
                        <td>
                            <asp:TextBox ID="so_reviewedTextBox" runat="server" 
                                Text='<%# Bind("so_reviewed") %>' />
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="so_statusTextBox" runat="server" 
                                Text='<%# Bind("so_status") %>' />
                        </td>
                        <td>
                ...
                <EditItemTemplate>
                    <tr style="background-color: #DEF6FE;" id="itm_tr" runat="server">
                        ...
                        <td>
                                ...
                                <asp:Label ID="Label5" runat="server" Text='<%# Eval("so_reviewed") %>' />
                        </td>
                        <td>
                        ...
                        <td>
                                ...
                                <asp:Label ID="so_statusLabel" runat="server" Text='<%# Eval("so_status") %>' style="display:none" />
                            <asp:DropDownList ID="sostatus" runat="server" Width="70px" >
                            </asp:DropDownList>
                        </td>
                ...
                <SelectedItemTemplate>
                    <tr style="background-color: #E2DED6; font-weight: bold;color: #333333;">
                        ...
                        <td>
                            <asp:Label ID="so_statusLabel" runat="server" Text='<%# Eval("so_status") %>' />
                        </td>
                        <td>
                ...
                <ContentTemplate>
                    <asp:GridView ID="mygrid_so" runat="server" AutoGenerateColumns="False" 
                        onrowdatabound="mygrid_so_RowDataBound" Width="100%" ShowHeader="False" 
                        onrowcommand="mygrid_so_RowCommand">
                    <Columns>
            ...
            <asp:ModalPopupExtender ID="btndummy_ModalPopupExtender" runat="server" 
                  TargetControlID="btndummy"  PopupControlID="upop"
                  BackgroundCssClass="modal"></asp:ModalPopupExtender>
            
            <div style="width:500px;height:500px;background-color:#ECE1C3;border:solid 2px #063940;" id="upop">
                  <div style="height:25px;padding:5px 10px;font-size:18px;font-weight:bold;background-color:#063940;color:#ECE1C3;">Upload SO</div>
                
                  <div style="padding:5px 10px">
                  <table cellpadding="5">
                  <tr>
                  <td style="width:100px">SO. NO.</td>
                  <td >
                      <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                      <ContentTemplate>
                      <asp:Label ID="lblmode" runat="server" Text="1" style="display:none"></asp:Label>
                      <asp:TextBox ID="txt_sono" runat="server" Width="100px"></asp:TextBox>
                      
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"  ValidationGroup ="drgroup" ErrorMessage="*" ForeColor="Red" ControlToValidate="txt_sono"></asp:RequiredFieldValidator>
                      </ContentTemplate>
                      </asp:UpdatePanel>
                      </td>
                  </tr>
                      <tr>
                          ...
                          <td>
                             ...
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"  ValidationGroup ="drgroup" ErrorMessage="*" ForeColor="Red" ControlToValidate="txt_subject"></asp:RequiredFieldValidator>
                              </ContentTemplate>
                              </asp:UpdatePanel>
                  ...
                  <tr>
                  <td style="width:100px">REVIEW BY</td>
                  <td >
                  ...
                  <tr>
                  <td style="width:100px">ISSUED TO</td>
                  <td >
                     ...
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"  ValidationGroup ="drgroup" ErrorMessage="*" ForeColor="Red" ControlToValidate="txt_issuedto"></asp:RequiredFieldValidator>
                      </ContentTemplate>
                      </asp:UpdatePanel>
                  ...
                  <tr>
                  <td style="width:100px">DATE OF ISSUE</td>
                  <td >
                      ...
                      <asp:CalendarExtender ID="CalendarExtender58" runat="server" 
                                ClearTime="true" Format="dd/MM/yyyy" PopupButtonID="txt_issuedate" 
                                TargetControlID="txt_issuedate">
                            </asp:CalendarExtender>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"  ValidationGroup ="drgroup" ErrorMessage="*" ForeColor="Red" ControlToValidate="txt_issuedate"></asp:RequiredFieldValidator>
                      </ContentTemplate>
                      </asp:UpdatePanel>
                  ...
                  <tr>
                  <td style="height:70px;vertical-align:top;">SELECT DOCUMENT</td>
                  ...
                  <td>
                      ...
                      <ContentTemplate>
                      <asp:DropDownList ID="so_status" runat="server" >
                  ...
                  <td>
                      ...
                      <ContentTemplate>
                      <asp:Button ID="btnupload" runat="server" Text="Upload" ValidationGroup ="drgroup"
