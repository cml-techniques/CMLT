<%@ Page language="c#" Codebehind="multipleuploads.aspx.cs" AutoEventWireup="True" Inherits="webchange.attachme" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="attachme" method="post" encType="multipart/form-data" runat="server">
			...
			<asp:button id="AddFile" style="Z-INDEX: 103; LEFT: 34px; POSITION: absolute; TOP: 254px" runat="server" CssClass="bluebutton" Height="23px" Width="72px" Text="Add" onclick="AddFile_Click"></asp:button>
			<asp:button id="RemvFile" style="Z-INDEX: 104; LEFT: 119px; POSITION: absolute; TOP: 255px" runat="server" CssClass="bluebutton" Height="23px" Width="72px" Text="Remove" onclick="RemvFile_Click"></asp:button>
