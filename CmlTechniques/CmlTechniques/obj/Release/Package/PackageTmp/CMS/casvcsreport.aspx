<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casvcsreport.aspx.cs" Inherits="CmlTechniques.CMS.casvcsreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
            ...
            <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                        ...
                        <td style="font-weight: bold"><asp:Label ID="lblhead" runat="server" Text="CAS ELV7 - Voice Communication System Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv" >
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2252px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of VCS Commissioning and Testing</h2>
