<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas3Freport.aspx.cs" Inherits="CmlTechniques.CMS.cas3Freport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.2.9 - Voice/ Data Commissioning Activity Schedule</td>
                    </tr>
                </table>
        ...
        <td style="width:200px" align="center" rowspan="2">FED TO</td>
        ...
        <td style="width:100px" align="center" rowspan="2">NO.OF TEL/DATA/ VIDEO POINTS</td>
        <td align="center" colspan="2">NO.OF FO BACKBONE CABLE</td>
        <td align="center" colspan="2">NO.OF CAT6a BACKBONE CABLE</td>
        <td align="center" colspan="2">NO.OF CAT3 HORIZONTAL CABLE</td>
        <td align="center" colspan="2">FINAL TEST SHEETS</td>
        <td style="width:100px" align="center" rowspan="2">MDF/IDF ENERGISATION DATE</td>
        <td style="width:100px" align="center" rowspan="2">IR-FPT SIGN OFF [CML]</td>
        ...
        <td style="width:100px" align="center">TESTED</td>
        <td style="width:100px" align="center">TOTAL</td>
        <td style="width:100px" align="center">TESTED</td>
        <td style="width:100px" align="center">TOTAL</td>
        <td style="width:100px" align="center">TESTED</td>
        <td style="width:100px" align="center">CML ACCEPTED</td>
