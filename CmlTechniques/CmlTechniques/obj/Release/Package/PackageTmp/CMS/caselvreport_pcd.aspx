<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="caselvreport_pcd.aspx.cs" Inherits="CmlTechniques.CMS.caselvreport_pcd" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
      <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text="CAS ELV9 ELV Services | Car Park Management Commissioning Activity Schedule"></asp:Label>
                               //  
                               </td>                                                       
                            <td>
        ...
        <div id="HeaderDiv" >
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2670px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:200px" align="center" rowspan="2">SYSTEMS CONTROLLED/ MONITORED</td>
        <td style="width:200px" align="center" rowspan="2">FED FROM</td>
        <td style="width:100px" align="center" rowspan="2">TOTAL NO.OF POINTS</td>
        <td style="width:100px" align="center" rowspan="2">NO.DEVICES REQ&#39;D CALIBRATION</td>
        <td style="width:100px" align="center" rowspan="2">PLANNED COMPLETION DATE&nbsp;</td>
        <td align="center" colspan="6">COMMISSIONING &amp; TESTING</td>
        ...
        <td style="width:100px" align="center">CONTINUITY / IR TEST</td>
        <td style="width:100px" align="center">DOOR INTERCOM   ALERT / BELL</td>
        <td style="width:100px" align="center">AUDIO / VISUAL TEST</td>
        <td style="width:100px" align="center">DOOR RELEASE TEST</td>
        ...
        <div style="position:relative;float:left;width:2670px">
            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
            <ContentTemplate>
            <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" 
                Width="2670px" onrowdatabound="mymaster_RowDataBound" 
                Font-Names="Verdana" 
                    Font-Size="X-Small" ShowHeader="False" GridLines="None" >
            <Columns>
            <asp:TemplateField>
            <ItemTemplate>
            <table id="inner_table" width="2670px">
            <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
            <td style="width:50px">
            ...
            <td style="font-weight: bold;width:2670px" align="left">
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of CPMS Commissioning and Testing</h2>
