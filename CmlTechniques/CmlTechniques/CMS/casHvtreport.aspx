<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casHvtreport.aspx.cs" Inherits="CmlTechniques.CMS.casHvtreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
            ...
            <ContentTemplate>
         <asp:Button ID="print" runat="server" Text="Print Report"  OnClick="print_Click"
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        <td style="font-weight: bold">
                            <asp:Label ID="lblhead" runat="server" Text="CAS MISC1 - Horizontal & Vertical Transportation Systems Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <td align="center" colspan="2">LIFT COMMISSIONING</td>
        ...
        <td align="center">TESTED &amp; COMM.</td>
        <td align="center">3 PARTY INSPECTED</td>
        <td align="center">EMERGENCY LIGHTING</td>
        <td align="center">POWER FAILURE MODE</td>
        <td align="center">LIFT MONITORING SYSTEM</td>
        <td align="center">INTERCOM</td>
        <td align="center">BMS/FIRE ALARM INTERFACE</td>
        <td align="center">% TEST COMPLETED</td>
        ...
        <div style="position:relative;float:left;width:2564px">
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="F_from">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("per_com8")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField ="TESTED" HeaderText="NO.OF EQUIPMENTS TESTED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>    
