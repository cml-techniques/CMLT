<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casklereport_oph.aspx.cs" Inherits="CmlTechniques.CMS.casklereport_oph" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text="CAS MISC2 - Kitchen & Laundry Equipments Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2561px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">PLANT POWER ON</td>
        ...
        <td style="width:100px" align="center" rowspan="2">FUNCTIONAL TEST (@ MAX AMPS)</td>
        <td style="width:100px" align="center" rowspan="2">INTERFACE TEST</td>
        <td style="width:100px" align="center" rowspan="2">% TEST COMPLETED</td>
 ...
 <ContentTemplate>
   <asp:DropDownList ID="drfed" runat="server" Width="100%" 
        ...
        <div style="position:relative;float:left;width:2561px">
            ...
            <div>
            <br />
            <h2 style="margin:0">Summary of Kitchen & Laundry Equipments Commissioning and Testing</h2>
