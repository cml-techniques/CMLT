<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lvgentesting.aspx.cs" Inherits="CmlTechniques.lvgentesting" %>
...
<body>
                    ...
                    onitemcommand="myview_ItemCommand" onitemupdating="myview_ItemUpdating"  >
                        <ItemTemplate>
                            <tr style="background-color: #F7F6F3;color: #333333;">
                                ...
                                <td style="width:75px">
                                    <asp:Label ID="precom_Label" runat="server" Text='<%# Eval("pre_com_test") %>' Width="75px" />
                                </td>
                                <td>
                                    <asp:Label ID="cf_Label" runat="server" Text='<%# Eval("c_f_test") %>' Width="75px" />
                                </td>
                                <td>
                                    <asp:Label ID="ir_Label" runat="server" Text='<%# Eval("ir_") %>' Width="75px" />
                                </td>
                                <td>
                                    <asp:Label ID="load_Label" runat="server" 
                                        Text='<%# Eval("load_test") %>' Width="75px" />
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:Label ID="fulrun_Label" runat="server" 
                                        Text='<%# Eval("full_run_test") %>' Width="75px" />
                                </td>
                                <td>
  ...
  >
                                ...
                                <td >
                                    <%--<BDP:BasicDatePicker ID="dt_torque" runat="server" SelectedValue='<%# Bind("pre_com_test") %>' Width="75px" ></BDP:BasicDatePicker>--%>  
                                    <asp:TextBox ID="pre_com_test" runat="server" 
                                         Width="75px" Text='<%# Bind("pre_com_test") %>' />
                                        <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="pre_com_test" PopupButtonID="pre_com_test" ClearTime="true" Format="dd/MM/yyyy" ></asp:CalendarExtender>
                                </td>
                                <td>
                                    <%--<BDP:BasicDatePicker ID="dt_ir" runat="server" SelectedValue='<%# Bind("c_f_test") %>' Width="75px" ></BDP:BasicDatePicker>--%>  
                                    <asp:TextBox ID="c_f_test" runat="server" 
                                         Width="75px" Text='<%# Bind("c_f_test") %>' />
                                        <asp:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="c_f_test" PopupButtonID="c_f_test" ClearTime="true" Format="dd/MM/yyyy" ></asp:CalendarExtender>
                                </td>
                                <td>
                                        <%--<BDP:BasicDatePicker ID="dt_pressure" runat="server" SelectedValue='<%# Bind("ir_") %>' Width="75px" ></BDP:BasicDatePicker> --%> 
                                        <asp:TextBox ID="ir_" runat="server" 
                                         Width="75px" Text='<%# Bind("ir_") %>' />
                                        <asp:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="ir_" PopupButtonID="ir_" ClearTime="true" Format="dd/MM/yyyy" ></asp:CalendarExtender>
                                </td>
                                <td>
                                <%--<BDP:BasicDatePicker ID="dt_sec" runat="server" SelectedValue='<%# Bind("load_test") %>' Width="75px" ></BDP:BasicDatePicker>--%>  
                                <asp:TextBox ID="load_test" runat="server" 
                                         Width="75px" Text='<%# Bind("load_test") %>' />
                                        <asp:CalendarExtender ID="CalendarExtender5" runat="server" TargetControlID="load_test" PopupButtonID="load_test" ClearTime="true" Format="dd/MM/yyyy" ></asp:CalendarExtender>
                                </td>
                                <td>
                                ...
                                <td>
                                        <%--<BDP:BasicDatePicker ID="dt_fun" runat="server" SelectedValue='<%# Bind("full_run_test") %>' Width="75px" ></BDP:BasicDatePicker>--%>
                                        <asp:TextBox ID="full_run_test" runat="server" 
                                         Width="75px" Text='<%# Bind("full_run_test") %>' />
                                        <asp:CalendarExtender ID="CalendarExtender7" runat="server" TargetControlID="full_run_test" PopupButtonID="full_run_test" ClearTime="true" Format="dd/MM/yyyy" ></asp:CalendarExtender>  
                                </td>
                                <td>
