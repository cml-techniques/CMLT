<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casFUELreport.aspx.cs" Inherits="CmlTechniques.CMS.casFUELreport" %>
...
//        WinPrint.document.write("<div style='font-family:Calibri; font-size:6px'>");
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small;width:100%">
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold;color:#fff">
                            <asp:Label ID="lblhead" runat="server" Text="CAS Fuel System Services Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2567px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of Fuel System Services Commissioning and Testing</h2>
             <div >
