...
{
    public partial class casmvhvreport : System.Web.UI.Page
    {
        [Serializable]
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Head_Merging();
               _exp = false;
               if (lblprj.Text != "HMIM" && lblprj.Text != "KHUH")
        ...
        protected void mygridsumm_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Cells[3].Text = (e.Row.Cells[3].Text != "N/A") ? (e.Row.Cells[3].Text + "%") : "N/A";
                e.Row.Cells[4].Text = (e.Row.Cells[4].Text != "N/A") ? (e.Row.Cells[4].Text + "%") : "N/A";
                e.Row.Cells[8].Text = (e.Row.Cells[3].Text == "N/A" && e.Row.Cells[4].Text == "N/A") ? "N/A" : (e.Row.Cells[8].Text + "%");
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[3].Text = (_count1 ==0)?"N/A":(Decimal.Round((_tested1 / _count1), 0, MidpointRounding.AwayFromZero)).ToString() + '%';
                e.Row.Cells[4].Text = (_count2 == 0) ? "N/A" : (Decimal.Round((_tested2 / _count2), 0, MidpointRounding.AwayFromZero)).ToString() + '%';
                e.Row.Cells[8].Text = (_count3 == 0) ? "N/A" : (Decimal.Round((_total / _count3), 0, MidpointRounding.AwayFromZero)).ToString() + '%';
        ...
        {
            Insert_Summary();
            string _path = "Cas_Report.aspx?id=2_P" + lblprj.Text + "_B" + drbuilding.SelectedItem.Value + "_F" + drflevel.SelectedItem.Value + "_C" + drcategory.SelectedItem.Value + "_D" + drfed.SelectedItem.Value + "_Z1" + "&Div=" + lbldiv.Text;
            ...
            try
            {
                ...
                foreach (var row in distinctRows)
                {
                    ...
                    foreach (var _row in _result)
                    {
                        ...
                        {
                            if (_row["test1"].ToString() == "N/A" && _row["test2"].ToString() == "N/A" && _row["test3"].ToString() == "N/A" && _row["test4"].ToString() == "N/A" && _row["test5"].ToString() == "N/A" && _row["test6"].ToString() == "N/A" && _row["test7"].ToString() == "N/A" && _row["test11"].ToString() == "N/A" && _row["test12"].ToString() == "N/A" && _row["test13"].ToString() == "N/A")
                                NAFlag1 = true | NAFlag1;
                            else
                            {
                        ...
                        if (_row["test14"].ToString() == "N/A" && _row["tested1"].ToString() == "N/A")
                            NAFlag2 = true | NAFlag2;
                        else
                    ...
                    if (NAFlag1 && NAFlag1)
                        ...
                        _drow[5] = _per2.ToString();
                    else if (NAFlag2)
                        _drow[5] = _per1.ToString();
                    else
                    {
        ...
        private void Insert_Summary()
        {
            ...
            foreach (var row in _result)
            {
                ...
                if (IsNumeric(row["PER_COMPLETED"].ToString()) == true)
                    ...
                    _objcls.per_com1 = (row["PER_COMPLETED"].ToString() == "N/A")?-1:0;
                if (IsNumeric(row["PER_COMPLETED1"].ToString()) == true)
                    _objcls.per_com2 = Convert.ToDecimal(row["PER_COMPLETED1"].ToString());
                else
                    _objcls.per_com2 = (row["PER_COMPLETED1"].ToString() == "N/A") ? -1 : 0;
                if (IsNumeric(row["PER_COMPLETED2"].ToString()) == true)
                    _objcls.per_com3 = Convert.ToDecimal(row["PER_COMPLETED2"].ToString());
                else
                    _objcls.per_com3 = (row["PER_COMPLETED2"].ToString() == "N/A") ? -1 : 0;

                if (_objcls.per_com1 == -1 && _objcls.per_com3 == -1)
                    _objcls.total = -1;
                else if (IsNumeric(row["TOTAL"].ToString()) == true)
