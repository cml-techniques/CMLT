<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas3Kreport.aspx.cs" Inherits="CmlTechniques.CMS.cas3Kreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.2.11 - Nurse Call and Code Blue System Commissioning Activity Schedule</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3538px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:200px" align="center" rowspan="2">AREA COVERED</td>
        ...
        <td style="width:100px" align="center" rowspan="2">POWER SUPPLY / BATTERY BACKUP 
            TEST</td>
        <td style="width:100px" align="center" rowspan="2">NURSE CALL ETHERNET SWITCH TEST</td>
        <td style="width:100px" align="center" rowspan="2">NURSE CALL CORRIDOR LIGHT TEST</td>
        <td style="width:100px" align="center" rowspan="2">NURSE CALL AUDIO STATION TEST</td>
        <td style="width:100px" align="center" rowspan="2">NURSE CALL SINGLE BUTTON STATION 
            TEST</td>
        <td style="width:100px" align="center" rowspan="2">NURSE CALL STAFF TERMINAL STATION 
            TEST</td>
        <td style="width:100px" align="center" rowspan="2">NURSE CALL MASTER STATION TEST</td>
             ...
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:TemplateField HeaderText="PRE-COMMSSIONED" HeaderStyle-Font-Bold="false">
                 ...
                 <asp:TemplateField HeaderText="COMMISSIONED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("COMM")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
                 <asp:TemplateField HeaderText="% COMPLETED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("COMPLETED1")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
