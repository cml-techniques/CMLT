<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas1Greport.aspx.cs" Inherits="CmlTechniques.CMS.cas1Greport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.2.7 - Lighting Control Systems Commissioning Activity Schedule</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3179px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:150px" align="center" rowspan="2">AREA COVERED&nbsp;</td>
        ...
        <td style="width:100px" align="center" rowspan="2">NO.OF CHANNELS/ MODULES</td>
        ...
        <td style="width:100px" align="center" rowspan="2">NO.OF CHANNELS/ MODULES TESTED</td>
