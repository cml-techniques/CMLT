<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casgenreport.aspx.cs" Inherits="CmlTechniques.CMS.casgenreport" ValidateRequest="false" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2773px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" colspan="6">GENERATOR SET STAND ALONE TESTING</td>
        <td align="center" colspan="3">OUT GOING CIRCUIT TESTING</td>
        <td align="center" colspan="3">SITE OPERATION &amp; LOAD TEST</td>
        ...
        <td style="width:100px" align="center">ALARM &amp; SHUTDOWN TEST</td>
        <td style="width:100px" align="center">LOAD BANK TEST</td>
        <td style="width:100px" align="center">GENERATOR SET TEST PROGRESS</td>
        <td style="width:100px" align="center">CONSULTANT ACCEPTED</td>
        <td style="width:100px" align="center">TEST SHEETS FILED</td>
        <td style="width:100px" align="center">CABLE COLD TEST</td>
        <td style="width:100px" align="center">CONSULTANT ACCEPTED</td>
        <td style="width:100px" align="center">TEST SHEETS FILED</td>
        <td style="width:100px" align="center">SITE OPERATION &amp; LOAD TEST</td>
        <td style="width:100px" align="center">CONSULTANT ACCEPTED</td>
        <td style="width:100px" align="center">TEST SHEETS FILED</td>
        </tr>
        <tr bgcolor="#092443">
        ...
        <div style="position:relative;float:left;width:2773px">
            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
            <ContentTemplate>
            <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" 
                Width="2773px" onrowdatabound="mymaster_RowDataBound" 
                Font-Names="Verdana" 
                    Font-Size="X-Small" ShowHeader="False" GridLines="None" >
            <Columns>
            <asp:TemplateField>
            <ItemTemplate>
            <table id="inner_table" width="2773px">
            <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
            <td style="width:50px">
            ...
            <td style="font-weight: bold;width:2773px" align="left">
