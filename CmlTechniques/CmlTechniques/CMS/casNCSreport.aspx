<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casNCSreport.aspx.cs" Inherits="CmlTechniques.CMS.casNCSreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" style="display:none" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold"><asp:Label ID="lblhead" runat="server" Text="CAS ELV 9 Nurse Call System Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <td style="width:100px" align="center">DEVICE TEST</td>
        <td style="width:100px" align="center">ADDRESSING / PROGRAMMING TEST</td>
        <td style="width:100px" align="center">FAULT & ALARM TESTS</td>
