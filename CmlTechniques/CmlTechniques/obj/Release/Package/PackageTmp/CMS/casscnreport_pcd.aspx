<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casscnreport_pcd.aspx.cs" Inherits="CmlTechniques.CMS.casscnreport_pcd" %>
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField ="QTY" HeaderText="NO.OF POINTS" HeaderStyle-Font-Bold="false" > 
                   ...
                   <asp:BoundField DataField ="QTY_PLANNED" HeaderText="NO.OF POINTS PLANNED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
