<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casISTreport.aspx.cs" Inherits="CmlTechniques.CMS.casISTreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lblhead" runat="server" Text="CAS E7 Integrated System Testing Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv" >
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:1870px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" rowspan="2">POWER FAIL/ EMERGENCY CONDITION</td>
        <td align="center" rowspan="2">MEASURED PUE</td>
        <td align="center" rowspan="2">ENVIORNMENTAL BUILDING TEST</td>
        <td align="center" rowspan="2">TEST SHEETS FILED</td>
        ...
        <div style="position:relative;float:left;width:1870px">
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                Font-Names="Verdana" 
                Font-Size="X-Small" ShowHeader="false" Width="1870px" >
                <Columns>
                <asp:BoundField >
        ...
        <div >
            ...
            <br />
            <h2 style="margin:0">Summary of Integrated System Testing </h2>
            <div>
            <div >
