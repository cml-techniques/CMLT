<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas3Lreport.aspx.cs" Inherits="CmlTechniques.CMS.cas3Lreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.2.13 - Master Clock System Commissioning Activity Schedule</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2717px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">NO.OF CODE BLUE/ ELAPSED TIMERS</td>
        <td style="width:100px" align="center" rowspan="2">CONTINUITY/ CABLE TEST COMPLETE</td>
        <td style="width:100px" align="center" rowspan="2">NO.OF CODE BLUE/ELAPSED TIMERS 
            TESTED</td>
        ...
        <td style="width:100px" align="center" rowspan="2">COMMISSIONING COMPLETE</td>
