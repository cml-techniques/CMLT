<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casavireport_pcd.aspx.cs" Inherits="CmlTechniques.CMS.casavireport_pcd" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text="CAS ELV8 Audio-Visual Intercom Commissioning Activity Schedule"></asp:Label>
                            //
                            </td>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2052px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" colspan="5">COMMISSIONING &amp; TESTING</td>
        ...
        <div style="position:relative;float:left;width:2052px">
            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
            <ContentTemplate>
            <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" 
                Width="1952px" onrowdatabound="mymaster_RowDataBound" 
                Font-Names="Verdana" 
                    Font-Size="X-Small" ShowHeader="False" GridLines="None" >
            <Columns>
            <asp:TemplateField>
            <ItemTemplate>
            <table id="inner_table" width="2052px">
            <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
            <td style="width:50px">
            ...
            <td style="font-weight: bold;width:2052px" align="left">
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of AVI Commissioning and Testing</h2>
