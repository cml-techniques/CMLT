<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casflureport_oph.aspx.cs" Inherits="CmlTechniques.CMS.casflureport_oph" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small;width:100%">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lblhead" runat="server" Text="CAS M2 Flushing Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv" >
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2810px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">FLUSHING STAGE</td>
        <td style="width:100px" align="center" rowspan="2">PLANNED&nbsp;&nbsp; POWER ON</td>
        <td align="center" colspan="7">MECHANICAL SYSTEMS</td>
        <td align="center" rowspan="2">FLUSHING % COMPLETED</td>
        ...
        <td style="width:100px" align="center">PLANNED COMPLETION DATE</td>
        <td style="width:100px" align="center">PLAIN FLUSHING</td>
        <td style="width:100px" align="center">FLUSHING VELOCITIES RECORDED</td>
        <td style="width:100px" align="center">CHEMICAL CLEANING</td>
        <td style="width:100px" align="center">FLUSHING AFTER CHEMICAL CLEANING</td>
        <td style="width:100px" align="center">BACK FLUSHING COMPLETE</td>
        <td style="width:100px" align="center">FINAL CHEMICAL TREATMENT</td>
        ...
        <td align="center"></td>
        <td align="center"></td>
        <td align="center"><asp:UpdatePanel ID="UpdatePanel8" runat="server">
            <ContentTemplate>
        ...
        <div style="position:relative;float:left;width:2810px">
            ...
            <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" 
                Width="2810px" onrowdatabound="mymaster_RowDataBound" 
                Font-Names="Verdana" 
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of Flushing Commissioning and Testing</h2>
