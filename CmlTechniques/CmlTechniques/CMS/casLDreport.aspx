<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casLDreport.aspx.cs" Inherits="CmlTechniques.CMS.casLDreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lblhead" runat="server" Text="CAS ELV7-Leak Detection System Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
   ...
   <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2650px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:200px" align="center" rowspan="2">NO OF PROTECTION / DETECTION</td>
        <td style="width:200px" align="center" rowspan="2">CONTINUITY TEST</td>
        <td style="width:200px" align="center" rowspan="2">PROGRAMMING AND COMMUNICATION 
            TEST</td>
        <td style="width:200px" align="center" rowspan="2">COMMISSIONING</td>
        <td align="center" colspan="2">COMMISSIONING</td>
        ...
        <div >
            ...
            <br />
           <h2 style="margin:0">Summary of Leak Detection System Testing </h2>
            <div>
            <div >
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:BoundField DataField="SYS_NAME" HeaderText="EQUIPMENTS" HeaderStyle-Font-Bold="false" >
                    ...
                    <asp:BoundField DataField ="PER_COMPLETED" HeaderText="POWER FAIL/EMEGENCY CONDITION" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="200px" />
                    </asp:BoundField>
                     <asp:BoundField DataField ="PER_COMPLETED1" HeaderText="MEASURED PUE" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="200px" />
                    </asp:BoundField>
                 <asp:BoundField DataField ="PER_COMPLETED2" HeaderText="ENVIORNMENTAL BUILDING TEST" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="200px" />
                    </asp:BoundField>
