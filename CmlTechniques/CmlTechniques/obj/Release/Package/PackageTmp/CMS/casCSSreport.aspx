<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casCSSreport.aspx.cs" Inherits="CmlTechniques.CMS.casCSSreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text="CAS ELV 12 Computing & Data Storage Systems(CSS) Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div style="position:relative;float:left;width:2252px">
            ...
            <div>
            <br />
            <h2 style="margin:0">Summary of CSS Commissioning &amp; Testing</h2>
