<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casph2report_oph.aspx.cs" Inherits="CmlTechniques.CMS.casph2report_oph" %>
    ...
    <form id="form1" runat="server">
     <div style="font-family: verdana; font-size: xx-small">
       ...
       <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;width:100%;height:26px">
        ...
        <td style="font-weight: bold">
            <asp:Label ID="lblhead" runat="server" Text="CAS PH2 Fire Protection Services  Commissioning Activity Schedule"></asp:Label></td>
        </tr>
        </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3176px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">PLANNED COMP DATE</td>
