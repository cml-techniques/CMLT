...
{
    public partial class additionalview : System.Web.UI.Page
    {
        ...
        void _ReadCookies()
        {
            if (Request.Browser.Cookies)
            {
                ...
                if (Request.Cookies["_datapath"] != null)
                {
                    Session["_datapath"] = Server.HtmlEncode(Request.Cookies["_datapath"].Value);
                }
