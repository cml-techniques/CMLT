<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="caslcsreport.aspx.cs" Inherits="CmlTechniques.CMS.caslcsreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
      ...
      <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;width:100%;height:26px">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2155px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <div style="position:relative;float:left;width:2155px">
            ...
            <asp:TemplateField>
            <ItemTemplate>
            <table id="inner_table" width="2155px">
            <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
            <td style="width:50px">
            ...
            <td style="font-weight: bold;width:2155px" align="left">
