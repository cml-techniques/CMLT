<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casTetraeport.aspx.cs" Inherits="CmlTechniques.CMS.casTetraeport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text="CAS ELV 10 - GSM & TETRA Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2161px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">
            NO.OF POINTS</td>
        <td style="width:100px" align="center" rowspan="2">CABLE TEST</td>
        <td style="width:100px" align="center" rowspan="2">REPEATER FUNCTIONAL TEST</td>
        <td style="width:100px" align="center" rowspan="2">ANTENNA FUNCTIONAL TEST</td>
        <td style="width:100px" align="center" rowspan="2">SPLITTER FUNCTIONAL TEST</td>
        <td style="width:100px" align="center" rowspan="2">COUPLER FUNCTIONAL TEST</td>
        ...
        <div style="position:relative;float:left;width:2161px">
            ...
            <div>
            <br />
            <h2 style="margin:0">Summary of GSM/TETRA System Commissioning &amp; Testing</h2>
