<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casme1report.aspx.cs" Inherits="CmlTechniques.CMS.casme1report" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div id="HeaderDiv" >
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2893px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">PLANT START UP<br />(Date)</td>
        ...
        <td align="center" colspan="2">FINALTEST SHEETS</td>
        ...
        <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
        <td align="center" >BUILDING/ ZONE</td>
        <td align="center" >FLOOR LEVEL</td>
        <td align="center" >CATEGORY&nbsp;</td>
        <td align="center" >SEQ. NO</td>
        <td align="center">PRE-COMM<br />(Date)</td>
        <td align="center" >COMM<br />(Date)</td>
        <td align="center" >DESIGN VOLUME (l/s)</td>
        <td align="center" >OBTAINED VOLUME (l/s)</td>
        <td align="center" >OBTAINED PERCENTAGE %</td>
        <td align="center" >WITNESSED<br />(Date)</td>
        ...
        <div style="position:relative;float:left;width:2893px">
        ...
        <div>  
            <br />
            <h2 style="margin:0">
                <asp:Label ID="lblsummary_title" runat="server" Text="Summary of Commissioning and Testing" Visible="false"></asp:Label></h2>
