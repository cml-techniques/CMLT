<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casfesreport.aspx.cs" Inherits="CmlTechniques.CMS.casfesreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <td style="font-weight: bold">CAS M7 Fire Extinguishing Systems Commissioning Activity Schedule</td>
        </tr>
        </table>
        ...
        <td align="center" colspan="8">COMMISSIONING &amp; ACCEPTANCE</td>
        ...
        <td style="width:100px" align="center">INSTALLATION &amp; DOCUMENTATION COMPLETION</td>
        <td style="width:100px" align="center">PRE-COMM</td>
        <td style="width:100px" align="center">STAND ALONE COMMISSION</td>
        <td style="width:100px" align="center">FIRE &amp; BMS INTERFACE TEST</td>
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of Fire Extinguishing System Commissioning and Testing</h2>
             <div >
