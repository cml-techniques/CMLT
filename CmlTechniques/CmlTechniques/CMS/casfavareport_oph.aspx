<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casfavareport_oph.aspx.cs" Inherits="CmlTechniques.CMS.casfavareport_oph" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div  style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold"><asp:Label ID="lblhead" runat="server" Text="CAS ELV1 PABGM Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <td align="center" rowspan="2">SOUND LEVEL TEST PLANNED</td>
        ...
        <td align="center" rowspan="2">CAUSE &amp; EFFECT TESTS PLANNED</td>
             ...
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="Loc" >
                    ...
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                     ...
                     <asp:BoundField DataField="test16" >
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField ="PER_COMPLETED" HeaderText="NO.OF POINTS TESTED" HeaderStyle-Font-Bold="false" > 
                    ...
                    <asp:BoundField DataField ="PER_COMPLETED1" HeaderText="TOTAL COMMISSIONED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>    
