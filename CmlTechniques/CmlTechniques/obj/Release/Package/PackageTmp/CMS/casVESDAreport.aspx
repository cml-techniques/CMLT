<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casVESDAreport.aspx.cs" Inherits="CmlTechniques.CMS.casVESDAreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lblhead" runat="server" Text="CAS ELV 1a -VESDA System Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
   ...
   <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3950px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:150px" align="center" rowspan="2">CONTINUITY / IR TESTED PLANNED</td>
        <td style="width:150px" align="center" rowspan="2">CONTINUITY / IR TESTED</td>
        <td style="width:150px" align="center" rowspan="2">NO OF  TEST HOLES</td>
        <td style="width:150px" align="center" rowspan="2">NO OF TEST HOLES TESTED</td>
        <td style="width:150px" align="center" rowspan="2">TEST HOLE TEST COMPLETE PLANNED</td>
        <td style="width:150px" align="center" rowspan="2">TEST HOLE TEST COMPLETE</td>
        <td style="width:150px" align="center" rowspan="2">NO OF INTERFACES</td>
        <td style="width:150px" align="center" rowspan="2">FA INTERFACES TESTED</td>
        <td style="width:150px" align="center" rowspan="2">FA INTERFACE TEST COMPLETE 
            PLANNED</td>
        <td style="width:150px" align="center" rowspan="2">FA INTERFACE TEST COMPLETE</td>
        <td align="center" colspan="2">TEST SHEETS</td>
        <td style="width:150px" align="center" rowspan="2"> BATTERY AUTONOMY TEST</td>
        <td style="width:150px" align="center" rowspan="2">CAUSE & EFFECT TESTS PLANNED</td>
        <td style="width:150px" align="center" rowspan="2">CAUSE & EFFECT TESTS</td>
         <td align="center" colspan="2">FINAL TEST SHEETS</td>
        
        <td style="width:300px" align="center" rowspan="2">COMMENTS</td>
        
        <td style="width:150px" align="center" rowspan="2">ACTION BY</td>
        <td style="width:150px" align="center" rowspan="2">ACTION DATE</td>
        </tr>
        <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
        ...
        <td style="width:150px" align="center">CONSULTANT ACCEPTED</td>
        <td style="width:150px" align="center">TEST SHEETS FILED</td>
        <td style="width:150px" align="center">CONSULTANT ACCEPTED</td>
        <td style="width:150px" align="center">TEST SHEETS FILED</td>
        </tr>
        ...
        <div >
            ...
            <br />
           <h2 style="margin:0">Summary of VESDA System Testing </h2>
            <div>
            <div >
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:BoundField DataField="SYS_NAME" HeaderText="TESTS" HeaderStyle-Font-Bold="false" >
                    ...
                    <asp:BoundField DataField="TESTED" HeaderText="NO. OF POINTS TESTED" HeaderStyle-Font-Bold="false" >
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="150px" />
                    </asp:BoundField>
                     <asp:BoundField DataField ="TOTAL" HeaderText="% COMPLETE" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" Width="150px" />
                    </asp:BoundField>
