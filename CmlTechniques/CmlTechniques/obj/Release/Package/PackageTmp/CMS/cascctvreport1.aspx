<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cascctvreport1.aspx.cs" Inherits="CmlTechniques.CMS.cascctvreport1" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
       ...
       <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;width:100%;height:26px">
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold"><asp:Label ID="lblhead" runat="server" Text="CAS ELV3 - Visual Security Systems Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2458px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center">
           <asp:Label ID="lblvh" runat="server" Text="VSS VIEW FROM HEAD END" ></asp:Label>
        </td>
        ...
        <div style="position:relative;float:left;width:2458px">
            ...
            <asp:TemplateField>
            <ItemTemplate>
            <table id="inner_table" width="2458px">
            <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
            <td style="width:50px">
