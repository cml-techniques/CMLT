<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="caslvreport2.aspx.cs" Inherits="CmlTechniques.CMS.caslvreport2"  %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3388px;height:80px" cellspacing="1" border="0" id="headTbl" >
        ...
        <td style="width:100px" align="center" rowspan="2">FED FROM</td>
         ...
         <td align="center" colspan="2">PLANNED </td>
        ...
        <td style="width:100px" align="center">PLANNED POWER ON</td>
        ...
        <div style="position:relative;float:left;width:3388px">
            ...
            <asp:TemplateField>
            <ItemTemplate>
            <table id="inner_table" width="3388px">
            <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
            <td style="width:50px">
                ...
                <asp:BoundField DataField="F_from" >
                 ...
                 <asp:BoundField DataField="P_P_to" >
                    ...
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                      ...
                      <asp:BoundField DataField="Plannedcompletion" >
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
                ...
                <asp:TemplateField HeaderText="% PROGRESS" HeaderStyle-Font-Bold="false">
                 ...
                 <asp:TemplateField HeaderText="OVERALL PROGRESS" HeaderStyle-Font-Bold="false">
                    ...
                    <asp:BoundField DataField="PANEL" />
                     <asp:BoundField DataField ="TOTAL_PLANNED" HeaderText="TOTAL PLANNED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField> 
                      <asp:TemplateField HeaderText="PLANNED PERCENTAGE" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("PLANNED_PER")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
