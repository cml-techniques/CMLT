<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cassheet_DataEntry2.aspx.cs" Inherits="CmlTechniques.Cassheet_DataEntry2" %>
    ...
    <asp:Label ID="lblref" runat="server" Text="" CssClass="hidden"></asp:Label>
       ...
       <tr  style="background-image: url('images/head_bg.png'); background-repeat: repeat-x;">
            ...
            <td id="td_txtppt" runat="server">
                                <asp:TextBox ID="txtno1" runat="server" Width="94%" 
                                    ></asp:TextBox>
                                            </td>
            <td id="td_txtdes" runat="server">
                                <asp:TextBox ID="txtno2" runat="server" Width="94%"></asp:TextBox>
                                            </td>
            <td id="td_no" runat="server">
                                <asp:TextBox ID="txtno" runat="server" Width="94%"></asp:TextBox>
                                            </td>
            ...
            <div>
                ...
                <td width="250px">ENG.REF</td>
                    ...
                    <tr id="tr2" runat="server">
                        <td width="150px">
                            <asp:Label ID="lb3" runat="server" Text="FED TO"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr id="tr3" runat="server">
                        <td >
                            <asp:Label ID="lb1" runat="server" Text="NO.OF TEL/DATA/VIDEO POINTS"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="upno1" runat="server" Width="150px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr id="tr4" runat="server">
                        <td >
                            <asp:Label ID="lb2" runat="server" Text="NO.OF FO BACKBONE VABLE"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="upno2" runat="server" Width="150px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr id="tr6" runat="server">
                        <td >
                            <asp:Label ID="Label3" runat="server" Text="NO.OF CAT6a BACKBONE CABLE"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="upno" runat="server" Width="150px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr id="tr5" runat="server">
                        <td >
                            <asp:Label ID="lb4" runat="server" Text="NO.OF CAT3 HORIZONTAL CABLE"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="upnoof" runat="server" Width="150px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td width="150px">
