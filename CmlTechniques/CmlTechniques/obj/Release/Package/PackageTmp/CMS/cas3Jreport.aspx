<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas3Jreport.aspx.cs" Inherits="CmlTechniques.CMS.cas3Jreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.2.15 - Audio Visual System (AV) Commissioning Activity Schedule</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2923px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">NO.OF CIRCUITS TESTED</td>
        <td style="width:100px" align="center" rowspan="2">ENERGISATION DATE</td>
        <td style="width:100px" align="center" rowspan="2">PRE COMMISSIONING COMPLETE</td>
        <td style="width:100px" align="center" rowspan="2">AUDIO COMMISSIONING COMPLETE</td>
        <td style="width:100px" align="center" rowspan="2">VIDEO COMMISSIONING COMPLETE</td>
        <td style="width:100px" align="center" rowspan="2">REMOTE CONTROL SYSTEM TEST</td>
        <td style="width:100px" align="center" rowspan="2">FINAL ADJUSTMENT/ ACCEPTANCE DEMO</td>
