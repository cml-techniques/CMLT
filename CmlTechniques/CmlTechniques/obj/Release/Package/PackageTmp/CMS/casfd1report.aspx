<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casfd1report.aspx.cs" Inherits="CmlTechniques.CMS.casfd1report" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small;">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3355px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">ENGINEERS PLANT REF.</td>
        <td align="center" colspan="4">ASSET CODE</td>
        <td style="width:200px" align="center" rowspan="2">DESCRIPTION/ SIZE</td>
        <td align="center" colspan="2">LOCATION</td>
        <td style="width:150px" align="center" rowspan="2">PLANT/ SYSTEM DESCRIPTION</td>
        <td style="width:100px" align="center" rowspan="2">PFT INSTALLATION COMPLETION SIGN OFF 
            [KEO]</td>
        <td style="width:100px" align="center" rowspan="2">DAMPER CONTROL PANEL REFERENCE</td>
        <td style="width:100px" align="center" rowspan="2">POWER ON</td>
        <td style="width:100px" align="center" rowspan="2">CONTRACTORS PRE-COM DATE</td>
        <td align="center" colspan="2">ACCESS</td>
        <td align="center" colspan="5">COMMISSIONED</td>
        <td style="width:100px" align="center" rowspan="2">PFT COMPLETION SIGN OFF [CML]</td>
        <td style="width:100px" align="center" rowspan="2">FPT COMPLETION SIGN OFF [CML]</td>
        <td style="width:100px" align="center" rowspan="2">DOCUMENT FILED</td>
        <td style="width:120px" align="center" rowspan="2">ACCEPTANCE RECOMMENDATION MADE</td>
        ...
        <td style="width:150px" align="center">AREA</td>
        <td style="width:150px" align="center">ROOM REFERENCE</td>
        <td style="width:100px" align="center">ACCESS DOOR PROVIDED</td>
        <td style="width:100px" align="center">ACCESSABILITY (L/M/H)</td>
        <td style="width:100px" align="center">MECHANICAL/ FUNCTIONAL CHECK</td>
        <td style="width:100px" align="center">FIRESTAT CHECK</td>
        <td style="width:100px" align="center">FA INTERFACE</td>
        <td style="width:100px" align="center">EMCS INTERFACE</td>
        <td style="width:100px" align="center">% COMPLETE</td>
        </tr>
        <tr bgcolor="#092443">
        ...
        <td style="width:100px" align="center">&nbsp;</td>
        <td style="width:100px" align="center">&nbsp;</td>
        <td style="width:100px" align="center"><asp:UpdatePanel ID="UpdatePanel8" runat="server">
            <ContentTemplate>
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="F_from" >
                    ...
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("per_com3")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
        ...
        <div>  
            ...
            <div style="width:1870px">
             <div style="width:1620px;float:left">
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False"
                onrowdatabound="mygridsumm_RowDataBound" ShowFooter="true" 
                    onrowcreated="mygridsumm_RowCreated">
                ...
                <asp:BoundField DataField ="PRE_COMM_QTY" HeaderText="QUANTITY" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                <asp:TemplateField HeaderText="%" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("PRE_COMM_PER") + "%" %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField> 
                 <asp:BoundField DataField ="COMM_QTY" HeaderText="QUANTITY" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>      
                 <asp:TemplateField HeaderText="%" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate > 
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("COMM_PER") + "%" %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
                 ...
                 <asp:BoundField DataField ="INS_TOTAL" HeaderText="TOTAL NO. INSTALLATION SIGNED OFF" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>   
                 ...
                 <asp:BoundField DataField ="FPT_TOTAL" HeaderText="TOTAL NO. FPT SIGNED OFF" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField> 
