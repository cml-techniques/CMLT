<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casph3report_oph.aspx.cs" Inherits="CmlTechniques.CMS.casph3report_oph" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2255px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" rowspan="2">PLANNED COMP DATE</td>
        ...
        <td align="center" class="style1">ROOM/SYSTEM INTEGRITY TEST</td>
        <td align="center" class="style1">STAND ALONE COMMISSION</td>
        <td align="center" class="style1">FIRE &amp; BMS INTERFACE TEST</td>
        <td align="center" class="style1">% PROGRESS</td>
        <td align="center" class="style1">WITNESSED</td>
        ...
        <div style="position:relative;float:left;width:2255px">
            ...
            <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" 
                Width="2255px" onrowdatabound="mymaster_RowDataBound" 
                Font-Names="Verdana" 
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of FM200 Commissioning and Testing</h2>
