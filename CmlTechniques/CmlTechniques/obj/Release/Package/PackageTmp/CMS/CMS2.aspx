<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CMS2.aspx.cs" Inherits="CmlTechniques.CMS.CMS2" %>
    ...
    <script language="javascript" type="text/javascript">
      function callcms(_id, type) {
          if (type == "0") {
              ...
              document.getElementById("content").src = "cplans.aspx?id=" + _id;
          }
          else if (type == "sub") {
...
//              document.getElementById("content").src = "methodstatements1.aspx?id=" + _id;
              ...
              // location.replace("FactoryAcceptanceTestUploads1.aspx?" + _id);
              //document.getElementById("content").src = + _id;
              document.getElementById("content").src = "PDFUpload.aspx?" + _id;
          }
          else if (type == "39") {
              document.getElementById("content").src = "MonthlyReport.aspx?" + _id;
          }
          else if (type == "42") {
          ...
          //Jenevieve - 18/01/2018 - start
              ...
              document.getElementById("content").src = "Documents.aspx?id=" + _id;

          }
              //Jenevieve - 22/1/2018
          else if (type == "TDlog") {
              document.getElementById("content").src = "DocumentLog.aspx?id=" + _id;
  ...
  <link rel="shortcut icon" href="../Images/favicon.ico"/> 
    ...
    <FRAMESET cols="210px,100%" border="0" frameSpacing="0" frameBorder="0" id="main" runat="server">
       ...
       <FRAMESET rows="300px,100%" border="0" frameSpacing="0" frameBorder="0" >
         ...
         <FRAMESET rows="115px,100%" border="0" frameSpacing="0" frameBorder="0" id="container" runat="server">
