<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casElvIPTVreport.aspx.cs" Inherits="CmlTechniques.CMS.casElvIPTVreport" %>
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    Font-Names="Verdana" Font-Size="XX-Small" 
                    ForeColor="Red" onclick="btnreset_Click" style="display:none" /></ContentTemplate></asp:UpdatePanel>
                
                            </td>
                        <td style="font-weight: bold"><asp:Label ID="lblhead" runat="server" Text="CAS ELV 5 - Internet Protocol Television System Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2364px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center">ADDRESSING/ PROGRAMMING TEST</td>
        <td style="width:100px" align="center">FAULT &amp; ALARM TEST</td>
        <td style="width:100px" align="center">POWER FAILURE TEST</td>
        <td style="width:100px" align="center">INTERFACE TEST</td>
        <td style="width:100px" align="center">PC HEADEND/ GRAPHICS TEST</td>
        ...
        <div style="position:relative;float:left;width:2364px">
            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
            <ContentTemplate>
            <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" 
                Width="2364px" onrowdatabound="mymaster_RowDataBound" 
                Font-Names="Verdana" 
                    Font-Size="X-Small" ShowHeader="False" GridLines="None" >
            <Columns>
            <asp:TemplateField>
            <ItemTemplate>
            <table id="inner_table" width="2364px">
            <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
            <td style="width:50px">
            ...
            <td style="font-weight: bold;width:2364px" align="left">
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="Loc" >
                    ...
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("per_com7")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of IPTV Commissioning and Testing</h2>
