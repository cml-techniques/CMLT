<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casgrmsreport_PCD.aspx.cs" Inherits="CmlTechniques.CMS.casgrmsreport_PCD" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
       <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold"><asp:Label ID="lblhead" runat="server" Text="CAS ELV7 Guest Room Management System Commissioning Activity Schedule"></asp:Label>
                        //
                        </td>
                           ...
                           Planned reference date
                            ...
                            <asp:TextBox ID="txtpcddate" runat="server" Text="" Width="90px" ReadOnly="true">
                             ...
                             <asp:CalendarExtender ID="CalendarExtender_pcd" runat="server" ClearTime="true"    
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2564px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">NO.OF ACCESS CONTROLLED DOORS</td>
        ...
        <td align="center" class="style1">CONTINUITY/IR TESTED&nbsp;</td>
        <td align="center" class="style1">KEY CARD ACTIVATED</td>
        <td align="center" class="style1">DO NOT DISTURB(DND)/DOORBELL</td>
        <td align="center" class="style1">MAKE UP ROOM (MUR)</td>
        <td align="center" class="style1">FCU/TEMP CONTROL</td>
        <td align="center" class="style1">EMERGENCY MANAGEMENT SYSTEM</td>
        <td align="center" class="style1">LIGHTING SCENE CONTROL</td>
        <td align="center" class="style1">BLINDS CONTROL INTERFACE</td>
        <td align="center" class="style1">MONITORING INTERFACE (FUTURE)</td>
        <td align="center" class="style1">% COMPLETED</td>
        ...
        <div>  
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField ="PER_COMPLETED" HeaderText="TESTED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                    <asp:BoundField DataField ="TOTAL_PLANNED" HeaderText="PLANNED % COMPLETE" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
