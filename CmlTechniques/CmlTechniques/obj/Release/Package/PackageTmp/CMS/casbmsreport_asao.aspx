<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casbmsreport_asao.aspx.cs"
    Inherits="CmlTechniques.CMS.casbmsreport_asao" %>
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div style="background-color: #092443; color: White; font-weight: bold; font-size: small;
            ...
            <table>
                <tr>
                    ...
                    <td style="font-weight: bold">
                        <asp:Label ID="lblhead" runat="server" Text="CAS ELV2 Building Management System Commissioning Activity Schedule"></asp:Label>
                    </td>
                </tr>
            </table>
        ...
        <div id="HeaderDiv" >
            <table style="font-family: Verdana; font-size: x-small; background-color: #9EB6CE;
                height: 80px;width:3747px;" cellspacing="1" border="0" id="headTbl">
                <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
                    ...
                    <td style="width: 150px" align="center" rowspan="2">
                        SYSTEMS CONTROLLED/ MONITORED BY DDC
                    </td>
                    <td style="width: 100px" align="center" rowspan="2">
                        TOTAL NO.OF POINTS
                    </td>
                    <td style="width: 100px" align="center" rowspan="2">
                        NO.OF DEVICES REQ&#39;D CALIBRATION
                    </td>
                    <td style="width: 100px" align="center" rowspan="2">
                        NO.OF SYSTEM FOR SEQ. OF OP.</td>
                    <td style="width: 100px" align="center" rowspan="2">
                        NO.OF SYSTEM REQUIRED LOOP TUNING
                    </td>
                ...
                <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
                    ...
                    <td style="width: 100px" align="center">
                        SEQUENCE OF OPERATION TESTED</td>
                    <td style="width: 100px" align="center">
                ...
                <tr bgcolor="#092443">
                    ...
                    <td style="width: 100px" align="left">
                        <asp:UpdatePanel ID="UpdatePanel17" runat="server">
                            <ContentTemplate>
                                <asp:Button ID="btncollapse" runat="server" Text="Collapse All" Width="100px" ForeColor="Red"
        ...
        <div id="DataDiv" style="overflow: scroll; background-color: #FFF" onscroll="Onscrollfnction();">
            <div style="position: relative; float: left; width: 3747px">
                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" Width="3747px"
                                                ...
                                                <td colspan="2">
                                                    <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" OnRowCommand="mydetails_RowCommand"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="test15">
                                                                <ItemStyle Width="100px" HorizontalAlign="Center" />
                                                            </asp:BoundField>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" OnRowDataBound="mygridsumm_RowDataBound"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="OVERALL % with weighting" HeaderStyle-Font-Bold="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Width="100px" />
                                            <ItemTemplate>
