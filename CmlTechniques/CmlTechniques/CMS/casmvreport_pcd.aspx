<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casmvreport_pcd.aspx.cs" Inherits="CmlTechniques.CMS.casmvreport_pcd" ValidateRequest="false" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9; overflow:hidden;">
    ...
    <div style="font-family: verdana; font-size: xx-small; overflow:hidden;">
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lblhead" runat="server" Text="CAS E1 Electrical Services. HV-MV Switchgear & RMU Commissioning Activity Schedule"></asp:Label>
                            </td>
                             <td style="width:5px">
                            //
                            </td>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3891px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" colspan="14">PANEL SITE TESTING</td>
        <td align="center" colspan="7">22/11KV HV TEST</td>
        ...
        <td style="width:100px" align="center">PLANNED COMPLETION</td>
        ...
        <td style="width:100px" align="center">PLANNED COMPLETION</td>
                <td style="width:100px" align="center">NO. OF CABLES</td>
        ...
        <div style="position:relative;float:left;width:3891px">
            ...
            <asp:TemplateField>
            <ItemTemplate>
            <table id="inner_table" width="3891px">
            <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
            <td style="width:50px">
            ...
            <td style="font-weight: bold;width:3891px" align="left">
             ...
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="F_from">
                 ...
                 <asp:BoundField DataField="P_P_to"  >
                    ...
                    <ItemTemplate >
                        <asp:Label ID="lblpcd" runat="server" Text='<%# Eval("PCdate")  %>' Width="100px" ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="lblpcd1" runat="server" Text='<%# Eval("PCdate1")  %>' Width="100px" ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <ItemStyle Width="0px" HorizontalAlign="Center" />
                      ...
                      <asp:BoundField DataField="per_com4" >
                    <ItemStyle Width="0px" HorizontalAlign="Center" />
                    </asp:BoundField>   
                </Columns>
            </asp:GridView>
