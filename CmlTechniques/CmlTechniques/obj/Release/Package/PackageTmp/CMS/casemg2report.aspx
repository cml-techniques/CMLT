<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casemg2report.aspx.cs" Inherits="CmlTechniques.CMS.casemg2report" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2464px;height:80px" cellspacing="1" border="0" id="headTbl">
