<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas4Creport.aspx.cs" Inherits="CmlTechniques.CMS.cas4Creport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.4.10.2 - Fire Protection Distribution System Commissioning Activity Schedule</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2202px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">QUANTITY</td>
        ...
        <td style="width:100px" align="center" rowspan="2">TOTAL NO. PFT COMPLETION SIGNED 
            OFF</td>
        <td style="width:100px" align="center" rowspan="2">QUANTITY TESTED</td>
        <td style="width:100px" align="center" rowspan="2">WITNESSED DATE</td>
        ...
        <div >
            ...
            <br />
            <h2 style="margin:0">Summary of Fire Protection Distribution System Commissioning and Testing</h2>
            <div >
             ...
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:BoundField DataField ="TESTED" HeaderText="TESTED" HeaderStyle-Font-Bold="false" > 
                 ...
                 <asp:TemplateField HeaderText="% OVERALL COMPLETE" HeaderStyle-Font-Bold="false">
                    ...
                    <asp:BoundField DataField="COMPLETED2" />
              </Columns>
            </asp:GridView>
