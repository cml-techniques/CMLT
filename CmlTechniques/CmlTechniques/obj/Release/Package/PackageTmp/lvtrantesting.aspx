<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lvtrantesting.aspx.cs" Inherits="CmlTechniques.lvtrantesting" %>
...
<body>
                    ...
                    onitemcommand="myview_ItemCommand" onitemupdating="myview_ItemUpdating"  >
                        <ItemTemplate>
                            <tr style="background-color: #F7F6F3;color: #333333;">
                                ...
                                <td style="width:75px">
                                    <asp:Label ID="wir_Label" runat="server" Text='<%# Eval("wir_test") %>' Width="75px" />
                                </td>
                                <td>
                                    <asp:Label ID="ratio_Label" runat="server" Text='<%# Eval("ratio_test") %>' Width="75px" />
                                </td>
                                <td>
                                    <asp:Label ID="wr_Label" runat="server" Text='<%# Eval("wr_test") %>' Width="75px" />
                                </td>
                                <td>
                                    <asp:Label ID="vg_Label" runat="server" 
                                        Text='<%# Eval("vg_test") %>' Width="75px" />
                                </td>
                                <td>
                                    <asp:Label ID="fun_Label" runat="server" 
                                ...
                                <td>
                                    <asp:Label ID="hv_Label" runat="server" 
                                        Text='<%# Eval("hv_test") %>' Width="75px" />
                                </td>
                                <td>
                                    <asp:Label ID="lvirLabel" runat="server" 
                                        Text='<%# Eval("lv_ir_test_gen") %>' Width="75px" />
                                </td>
                                <td>
                        ...
                        <tr>
                            ...
                            <td align="center" valign="middle">
                                RATIO TEST</td>                            
                            <td align="center" valign="middle">
                                WINDING RESISTANCE</td>                            
                            <td align="center" valign="middle" >
                                VECTOR GROUP</td>                            
                            <td align="center" valign="middle">
                                TEMP_RELAY FUNCTIONAL TEST</td>                            
                            <td>
                                IR TEST</td>
                            <td>
                                HV TEST</td>
  ...
  >
                                ...
                                <td >
                                    <%--<BDP:BasicDatePicker ID="dt_torque" runat="server" SelectedValue='<%# Bind("wir_test") %>' Width="75px" ></BDP:BasicDatePicker>--%>  
                                    <asp:TextBox ID="wir_test" runat="server" 
                                         Width="75px" Text='<%# Bind("wir_test") %>' />
                                        <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="wir_test" PopupButtonID="wir_test" ClearTime="true" Format="dd/MM/yyyy" ></asp:CalendarExtender>
                                </td>
                                <td>
                                    <%--<BDP:BasicDatePicker ID="dt_ir" runat="server" SelectedValue='<%# Bind("ratio_test") %>' Width="75px" ></BDP:BasicDatePicker>--%> 
                                    <asp:TextBox ID="ratio_test" runat="server" 
                                         Width="75px" Text='<%# Bind("ratio_test") %>' />
                                        <asp:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="ratio_test" PopupButtonID="ratio_test" ClearTime="true" Format="dd/MM/yyyy" ></asp:CalendarExtender> 
                                </td>
                                <td>
                                        <%--<BDP:BasicDatePicker ID="dt_pressure" runat="server" SelectedValue='<%# Bind("wr_test") %>' Width="75px" ></BDP:BasicDatePicker>--%>  
                                        <asp:TextBox ID="wr_test" runat="server" 
                                         Width="75px" Text='<%# Bind("wr_test") %>' />
                                        <asp:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="wr_test" PopupButtonID="wr_test" ClearTime="true" Format="dd/MM/yyyy" ></asp:CalendarExtender>
                                </td>
                                <td>
                                <%--<BDP:BasicDatePicker ID="dt_sec" runat="server" SelectedValue='<%# Bind("vg_test") %>' Width="75px" ></BDP:BasicDatePicker> --%> 
                                <asp:TextBox ID="vg_test" runat="server" 
                                         Width="75px" Text='<%# Bind("vg_test") %>' />
                                        <asp:CalendarExtender ID="CalendarExtender5" runat="server" TargetControlID="vg_test" PopupButtonID="vg_test" ClearTime="true" Format="dd/MM/yyyy" ></asp:CalendarExtender>
                                </td>
                                <td>
                                        <%--<BDP:BasicDatePicker ID="dt_con" runat="server" SelectedValue='<%# Bind("functional_") %>' Width="75px" ></BDP:BasicDatePicker>--%> 
                                        <asp:TextBox ID="functional_" runat="server" 
                                         Width="75px" Text='<%# Bind("functional_") %>' />
                                        <asp:CalendarExtender ID="CalendarExtender6" runat="server" TargetControlID="functional_" PopupButtonID="functional_" ClearTime="true" Format="dd/MM/yyyy" ></asp:CalendarExtender> 
                                </td>
                                <td>
                                        <%--<BDP:BasicDatePicker ID="dt_c_c" runat="server" SelectedValue='<%# Bind("ir_") %>' Width="75px" ></BDP:BasicDatePicker> --%>
                                        <asp:TextBox ID="ir_" runat="server" 
                                         Width="75px" Text='<%# Bind("ir_") %>' />
                                        <asp:CalendarExtender ID="CalendarExtender7" runat="server" TargetControlID="ir_" PopupButtonID="ir_" ClearTime="true" Format="dd/MM/yyyy" ></asp:CalendarExtender>
                                        
                                </td>
                                <td>
                                    <%--<BDP:BasicDatePicker ID="dt_hv" runat="server" SelectedValue='<%# Bind("hv_test") %>' Width="75px" ></BDP:BasicDatePicker>--%> 
                                    <asp:TextBox ID="hv_test" runat="server" 
                                         Width="75px" Text='<%# Bind("hv_test") %>' />
                                        <asp:CalendarExtender ID="CalendarExtender8" runat="server" TargetControlID="hv_test" PopupButtonID="hv_test" ClearTime="true" Format="dd/MM/yyyy" ></asp:CalendarExtender>
                                        
                                </td>
                                <td>
                                    <%--<BDP:BasicDatePicker ID="dt_l_c" runat="server" SelectedValue='<%# Bind("lv_ir_test_gen") %>' Width="75px" ></BDP:BasicDatePicker>--%> 
                                    <asp:TextBox ID="lv_ir_test_gen" runat="server" 
                                         Width="75px" Text='<%# Bind("lv_ir_test_gen") %>' />
                                        <asp:CalendarExtender ID="CalendarExtender9" runat="server" TargetControlID="lv_ir_test_gen" PopupButtonID="lv_ir_test_gen" ClearTime="true" Format="dd/MM/yyyy" ></asp:CalendarExtender>
                                </td>
                                <td>
