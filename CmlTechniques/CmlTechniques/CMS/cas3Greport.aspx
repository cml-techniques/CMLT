<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas3Greport.aspx.cs" Inherits="CmlTechniques.CMS.cas3Greport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.2.14 - Master Antenna Television System (MATV) Commissioning Activity Schedule</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div style="position:relative;float:left;width:3226px" id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3226px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">NO.OF POINTS PER OUTLETS</td>
        ...
        <td style="width:100px" align="center" rowspan="2">SYSTEM FUNCTION TEST AT TR&nbsp;</td>
        <td style="width:100px" align="center" rowspan="2">SYSTEM FUNCTION TESTS AT OUTLETS</td>
        <td style="width:100px" align="center" rowspan="2">SYSTEM FUNCTION TESTS AT HEADEND</td>
        <td style="width:100px" align="center" rowspan="2">INTEGRATION/ INTERFACE TEST</td>
