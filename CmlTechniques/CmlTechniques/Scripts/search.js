// ----------------------------------------------------------------------------
// Zoom Search Engine 6.0 (13/Jan/2009)
//
...
function ZoomInitSearch()
{
	...
	UseWildCards = new Array(numwords);
...
{
	document.writeln("<form method=\"get\" target=\"_self\" action=\"" + SelfURL + "\" class=\"zoom_searchform\">");
}

function ZoomShowSearchBox()
{
	document.writeln("<input type=\"text\" name=\"zoom_query\" size=\"10\" value=\"" + htmlspecialchars(query) + "\" id=\"zoom_searchbox\" class=\"zoom_searchbox\" />");
}
...
function ZoomShowResults()
{
	...
	{
		if (ZoomInfo == 1)
		//			document.writeln("<center><p><small>" + STR_POWEREDBY + " <a href=\"#\" zoom_target=\"_blank\"><b></b></a></small></p></center>");
		    document.writeln("");
		return;
	}
...
function ZoomShowPageNumbers()
{
	...
	if (ZoomInfo == 1)
//	    document.writeln("<center><p><small>" + STR_POWEREDBY + " <a href=\"#\" target=\"_blank\"><b>Zoom Search Engine</b></a></small></p></center>");
	document.writeln("");
}
