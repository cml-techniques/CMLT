<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casCPMreport.aspx.cs" Inherits="CmlTechniques.CMS.casCPMreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text=" CAS ELV13 - Car Park Management System Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3161px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:200px" align="center" rowspan="2">ROOM NO</td>
        <td style="width:200px" align="center" rowspan="2">DEVICE TYPE</td>
        <td style="width:200px" align="center" rowspan="2">FED FROM </td>
        <td align="center" rowspan="2" style="width:100px">NO.OF DEVICES</td>
        <td style="width:100px" align="center" rowspan="2">NO. DEVICES TESTED</td>
        <td style="width:100px" align="center" rowspan="2">CONTINUITY / IR</td>
        <td style="width:100px" align="center" rowspan="2">CONTINUITY / IR TESTED</td>
        <td style="width:100px" align="center" rowspan="2">FUNCTIONAL TEST</td>
        <td style="width:100px" align="center" rowspan="2">INTERFACE TEST</td>
        ...
        <td style="width:100px" align="center" rowspan="2">GRAPHICS / HEAD END TESTS</td>
        <td style="width:100px" align="center" rowspan="2">CONSULTANT ACCEPTED</td>
        <td style="width:100px" align="center" rowspan="2">TEST SHEETS FILED</td>
        ...
        <div style="position:relative;float:left;width:3161px">
            ...
            <div>
            <br />
            <h2 style="margin:0">Summary of CPMS System Commissioning Testing</h2>
