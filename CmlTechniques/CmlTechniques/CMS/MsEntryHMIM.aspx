<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MsEntryHMIM.aspx.cs" Inherits="CmlTechniques.CMS.MsEntryHMIM" %>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                    <ContentTemplate>
                                        <telerik:RadDropDownList ID="rd_Service" runat="server" Skin="Metro" RenderMode="Lightweight"
                                            DefaultMessage="Select Service" Width="350px"  AutoPostBack="true" CssClass="back-gey"
                                ...
                                <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                    <ContentTemplate>
                                        <telerik:RadDropDownList ID="rd_ms" runat="server" Skin="Metro" RenderMode="Lightweight" DefaultMessage="Select MS Systems" Width="350px" DropDownHeight="200px"
                                            AutoPostBack="true" CssClass="back-gey">
                                        </telerik:RadDropDownList>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
