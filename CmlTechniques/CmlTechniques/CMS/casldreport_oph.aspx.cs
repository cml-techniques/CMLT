...
{
    public partial class casldreport_oph : System.Web.UI.Page
    {
        [Serializable]
        ...
        protected void mygridsumm_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[4].Text = _tested2.ToString();
                e.Row.Cells[5].Text = _tested3.ToString();
                e.Row.Cells[6].Text = (Decimal.Round((_total / _count), 0, MidpointRounding.AwayFromZero)).ToString() + '%';
            }
        ...
        protected void print_Click(object sender, EventArgs e)
        {
            ...
            string _path = "Cas_Report.aspx?id=26_P" + lblprj.Text + "_B" + drbuilding.SelectedItem.Value + "_F" + drflevel.SelectedItem.Value + "_C" + drcategory.SelectedItem.Value + "_DAll_Z1";
        ...
        private void Generate_Summary()
        {
            try
            {
                ...
                foreach (var row in distinctRows)
                {
                    ...
                    _drow[2] = _p1.ToString();
                    _drow[3] = _p2.ToString();
                    _drow[4] = _p3.ToString();
