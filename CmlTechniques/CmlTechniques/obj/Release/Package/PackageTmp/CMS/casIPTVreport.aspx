<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casIPTVreport.aspx.cs" Inherits="CmlTechniques.CMS.casIPTVreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text="CAS ELV 9 IPTV System Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:1961px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">
            NO.OF EQUIPMENT</td>
        <td style="width:100px" align="center" rowspan="2">CABLE CONTINUITY TEST</td>
        <td style="width:100px" align="center" rowspan="2">AUDIO FUNCTIONAL TEST</td>
        <td style="width:100px" align="center" rowspan="2">VIDEO FUNCTIONAL TEST</td>
        ...
        <div style="position:relative;float:left;width:1961px">
            ...
            <div>
            <br />
            <h2 style="margin:0">Summary of IPTV Commissioning &amp; Testing</h2>
