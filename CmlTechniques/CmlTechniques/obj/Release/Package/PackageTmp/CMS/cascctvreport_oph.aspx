<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cascctvreport_oph.aspx.cs" Inherits="CmlTechniques.CMS.cascctvreport_oph" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
       ...
       <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;width:100%;height:26px">
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold"><asp:Label ID="lblhead" runat="server" Text="CAS ELV3 Closed Circuit Television Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv" >
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2393px;height:80px;" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">NO.OF CAMERAS</td>
        <td align="center" colspan="7">COMMISSIONING &amp; TESTING</td>
        ...
        <td style="width:100px" align="center">PLANNED COMPLETION DDATE&nbsp;</td>
        <td style="width:100px" align="center">CONTINUITY/ IR TESTED</td>
        <td style="width:100px" align="center">CCTV VIEW LOCALLY</td>
        <td style="width:100px" align="center">CCTV VIEW FROM HEAD END</td>
        <td style="width:100px" align="center">ADDRESSING/ SOFTWARE TEST</td>
        <td style="width:100px" align="center">RECORDING/ BACK-UP STORAGE TEST</td>
        ...
        <td style="width:100px" align="center"><asp:UpdatePanel ID="UpdatePanel8" runat="server">
                 <ContentTemplate>
                 <asp:Button ID="Button2" runat="server" Text="Collapse All" Width="100%" 
        ...
        <td style="width:100px" align="center">&nbsp;</td>
        <td style="width:100px" align="center">&nbsp;</td>
        <td style="width:100px" align="center"><asp:UpdatePanel ID="UpdatePanel9" runat="server">
            <ContentTemplate>
        ...
        <div style="position:relative;float:left;width:2393px">
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                Font-Names="Verdana" 
                Font-Size="X-Small" ShowHeader="false" Width="2393px" >
                <Columns>
                <asp:BoundField>
                ...
                <asp:BoundField DataField="Loc" >
                    ...
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("per_com6")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of CCTV Commissioning & Testing</h2>
