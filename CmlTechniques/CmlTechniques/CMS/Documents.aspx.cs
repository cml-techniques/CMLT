    ...
    public partial class Documents : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
               ...
               if(_prm.Contains("CML Documents, Reports and Presentations"))
                {
                    Session["mod_name"] = "DRP";
                    Session["reff_no"] = (string)Session["Fold_cms"] + "/" + (string)Session["M_id_cms"] + "/" + "DRP";
                }
                else if (_prm.Contains("CML Site Progress Reports"))
                {
                    Session["mod_name"] = "SPR";
                    Session["reff_no"] = (string)Session["Fold_cms"] + "/" + (string)Session["M_id_cms"] + "/" + "SPR";
                }
                else if (_prm.Contains("Site Witnessing Reports"))
                {
                    Session["mod_name"] = "SWR";
                    Session["reff_no"] = (string)Session["Fold_cms"] + "/" + (string)Session["M_id_cms"] + "/" + "SWR";
                }
        ...
        {
            ScriptManager.RegisterStartupScript(this, typeof(string), "close", "parent.callcms('" + Request.QueryString.ToString() + "','pdfupload');", true);
        }
    }
}