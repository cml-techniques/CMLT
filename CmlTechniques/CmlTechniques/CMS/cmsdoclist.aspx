<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cmsdoclist.aspx.cs" Inherits="CmlTechniques.CMS.cmsdoclist" %>
    ...
    <script type="text/javascript">
        function calldoc(type, id, file) {
            ...
            if (type == 1) {
                ...
                else if (mode.textContent == "Commissioning Reports") {
                    var prm = "prj=" + _prj.textContent + "&mode=CR&doc=" + id;
                    parent.callcms(prm, '5');
                }
            }
