<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casmereport_oph.aspx.cs" Inherits="CmlTechniques.CMS.casmereport_oph" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small;width:100%">
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold;color:#fff">
                            <asp:Label ID="lblhead" runat="server" Text="CAS M1 Mechanical Services Commissioning Activity Schedule "></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv" >
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2973px; height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" colspan="8">MECHANICAL SYSTEMS</td>
        ...
        <div style="position:relative;float:left;width:2973px">
            ...
            <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" 
                Width="2973px" onrowdatabound="mymaster_RowDataBound" 
                Font-Names="Verdana" 
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of Mechanical Commissioning and Testing</h2>
             <div >
