...
{
    public partial class casfdreport : System.Web.UI.Page
    {
        ...
        private void Load_Master()
        {
            ...
            if (lblprj.Text == "11784" && (Request.QueryString["sch"] != null))
            {
                ...
                if (Request.QueryString["sch"].ToString() == "32")
                {
        ...
        protected void print_Click(object sender, EventArgs e)
        {
             ...
             if (lblprj.Text == "11784" && (Request.QueryString["sch"] != null))
            {
             ...
             _path = "Cas_Report.aspx?id=9_P" + lblprj.Text + "_B" + drbuilding.SelectedItem.Value + "_F" + drflevel.SelectedItem.Value + "_C" + drcategory.SelectedItem.Value + "_D" + drfed.SelectedItem.Value + "_Z" + (string)Session["zero"] + "&Div=" + lbldiv.Text;
