<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casSASreport.aspx.cs" Inherits="CmlTechniques.CMS.casSASreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
     ...
     <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;height:26px">
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold"><asp:Label ID="lblhead" runat="server" Text="CAS SAS 1 - Special Airport System Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2729px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">ROOM NO</td>
        <td style="width:100px" align="center" rowspan="2">DEVICE TYPE</td>
        ...
        <td align="center" class="style1">CABLE TEST</td>
        <td align="center" class="style1">FUNCTIONAL TEST</td>
        ...
        <td align="center" class="style1">SEQUENCE OF OPERATION TEST</td>
        <td align="center" class="style1">GRAPHICS/ HEAD END TEST</td>
        <td align="center" class="style1">CONSULTANT ACCEPTED</td>
        <td align="center" class="style1">TEST SHEETS FILED</td>
        </tr>
        <tr bgcolor="#092443">
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of SAS Commissioning and Testing</h2>
