<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casgenreport_pcd.aspx.cs"
    Inherits="CmlTechniques.CMS.casgenreport_pcd" %>
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div style="background-color: #092443; color: White; font-weight: bold; font-size: small;
            ...
            <table>
                <tr>
                    ...
                    <td style="font-weight: bold">
                        <asp:Label ID="lblhead" runat="server" Text="CAS E5 Electrical Services. Generator Commissioning Activity Schedule"></asp:Label>
                    </td>
                    <td style="width: 5px">
                        //
                    </td>
        ...
        <div id="HeaderDiv">
            <table style="font-family: Verdana; font-size: x-small; background-color: #9EB6CE;
                width: 3073px; height: 80px" cellspacing="1" border="0" id="headTbl">
                <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
                    ...
                    <td align="center" colspan="7" class="style2">
                        GENERATOR SET STAND ALONE TESTING
                    </td>
                    <td align="center" colspan="4" class="style2">
                        OUT GOING CIRCUIT TESTING
                    </td>
                    <td align="center" colspan="4" class="style2">
        ...
        <div id="DataDiv" style="overflow: scroll; background-color: #FFF" onscroll="Onscrollfnction();">
            <div style="position: relative; float: left; width: 3073px">
                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" Width="3073px"
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" OnRowCreated="mygridsumm_RowCreated"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="count1" />
                                        <asp:BoundField DataField="count2" />
                                        <asp:BoundField DataField="count3" />
                                        <asp:BoundField DataField="_p1" />
                                        <asp:BoundField DataField="_p2" />
                                        <asp:BoundField DataField="_p3" />
                                        <asp:BoundField DataField="_pl1" />
                                        <asp:BoundField DataField="_pl2" />
                                        <asp:BoundField DataField="_pl3" />                                     
                                    </Columns>
                                </asp:GridView>
                                <input type="hidden" runat="server" id="hdnplper1" value="" />
                                <input type="hidden" runat="server" id="hdnacper1" value="" />
                                <input type="hidden" runat="server" id="hdnplper2" value="" />
                                <input type="hidden" runat="server" id="hdnacper2" value="" />
                                <input type="hidden" runat="server" id="hdnplper3" value="" />
                                <input type="hidden" runat="server" id="hdnacper3" value="" />
                                <input type="hidden" runat="server" id="hdnplper" value="" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                </div>
