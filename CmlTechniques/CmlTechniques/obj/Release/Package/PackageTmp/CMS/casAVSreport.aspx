<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casAVSreport.aspx.cs" Inherits="CmlTechniques.CMS.casAVSreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text="CAS ELV6 Audio Visual System Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <td style="width:100px" align="center" rowspan="2">NO.OF EQUIPMENTS</td>
        <td style="width:100px" align="center" rowspan="2">CONTINUITY / TEST</td>
        <td style="width:100px" align="center" rowspan="2">AVS TEST (AUDIO PART)</td>
        <td style="width:100px" align="center" rowspan="2">AVS TEST (VIDEO PART)</td>
        <td style="width:100px" align="center" rowspan="2">% TESTS COMPLETED</td>
 ...
 <asp:UpdatePanel ID="UpdatePanel18" runat="server">
        ...
        <div style="position:relative;float:left;width:2052px">
            ...
            <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" 
                Width="2052px" onrowdatabound="mymaster_RowDataBound" 
                Font-Names="Verdana" 
            ...
            <div>
            <br />
            <h2 style="margin:0">Summary of AVS Commissioning and Testing</h2>
