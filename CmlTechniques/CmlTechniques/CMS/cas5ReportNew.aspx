<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas5ReportNew.aspx.cs" Inherits="CmlTechniques.CMS.cas5ReportNew" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2817px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">INSTALLATION COMPLETION 
            SIGNED OFF KEO</td>
        <td style="width:100px" align="center" rowspan="2">PFT COMPLETION SIGNED 
            OFF KEO</td>
        <td style="width:100px" align="center" rowspan="2">PLANT START UP COMPLETE 
            CONTRACTORE</td>
        <td style="width:100px" align="center" rowspan="2">SYSTEM CONTACTER CHECKS COMPLETE</td>
        <td style="width:100px" align="center" rowspan="2">PTF COMPLETION</td>
        <td style="width:100px" align="center" rowspan="2">3RD PARTY VERIFICATION</td>
        <td style="width:100px" align="center" rowspan="2">FPT SIGN OFF [CML]</td>
        <td style="width:100px" align="center" rowspan="2">ACCEPTANCE RECOMMENDATION MADE</td>
        ...
        <div >
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:BoundField DataField ="PRE-COMM" HeaderText="PRE- COMMISSIONED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField> 
