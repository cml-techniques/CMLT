<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casvslreport.aspx.cs" Inherits="CmlTechniques.CMS.casvslreport" %>
...
<body>
    ...
    <div style="font-family: verdana; font-size: xx-small">
        <asp:ScriptManager ID="ScriptManager1" runat="server" />
         <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;width:2564px">
        <table >
                    <tr>
                        <td>
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lblhead" runat="server" Text="CAS MISC5 Vibration & Sound Level Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <td align="center" colspan="3">TESTS</td>
        ...
        <td align="center">NOISE LEVEL TESTING</td>
        <td align="center">VIBRATION TESTING</td>
        <td align="center">ACOUSTIC CONSULTANT ACCEPTED</td>
        <td align="center">ENGINEER ACCEPTED</td>
