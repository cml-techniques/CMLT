<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard_Print.aspx.cs" Inherits="CmlTechniques.CMS.Dashboard_Print" %>
...
<head>
    ...
    <script> 
        ...
        $(document).ready(function () {
            ...
            $('#loader9').hide();
<%--            var xhr = $.ajax({
                url: "Dashboard.aspx/GetExecutiveData",
        ...
        function drawServiceChart(chartData1, chartData2) {
            ...
            function selecthandler4() {
                var id2 = data4.getValue(columnchart4.getSelection()[0].row, 3);
                ...
                <table class="full-width">
                    ...
                    <img src='#' id="imglogo" class="col-height-100 col-width-100"/>  
                        ...
                        <td  class="text-center">
                            <ul>
                                <li>
                            <strong ><span class="cml-head"><asp:Label runat="server" ID="lblcmlhead" Text=""></asp:Label></span> </strong> 
                                </li>
