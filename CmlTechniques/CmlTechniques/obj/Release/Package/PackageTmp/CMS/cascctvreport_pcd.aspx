<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cascctvreport_pcd.aspx.cs"
    Inherits="CmlTechniques.CMS.cascctvreport_pcd" %>
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div style="background-color: #092443; color: White; font-weight: bold; font-size: small;
            ...
            <table>
                <tr>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel19" runat="server">
                            <ContentTemplate>
                                <asp:Button ID="btnzero" runat="server" Text="0% Completed" Font-Names="Verdana"
                                    Font-Size="XX-Small" ForeColor="Red" OnClick="btnzero_Click" Style="display: none" /></ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                    <td style="font-weight: bold">
                    ...
                    <td style="font-weight: bold">
                        <asp:Label ID="lblhead" runat="server" Text="CAS ELV3 Closed Circuit Television Commissioning Activity Schedule"></asp:Label>
                    </td>
                    <td style="width: 5px">
                        //
                    </td>
        ...
        <div id="HeaderDiv">
            <table style="font-family: Verdana; font-size: x-small; background-color: #9EB6CE;
                width: 2393px; height: 80px;" cellspacing="1" border="0" id="headTbl">
                ...
                <tr bgcolor="#092443">
                    ...
                    <td style="width: 100px" align="center">
                        <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                            <ContentTemplate>
                                <asp:Button ID="Button2" runat="server" Text="Collapse All" Width="100%" ForeColor="Red"
        ...
        <div id="DataDiv" style="overflow: scroll; background-color: #FFF" onscroll="Onscrollfnction();">
            <div style="position: relative; float: left; width: 2393px">
                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" Width="2393px"
                                                    ...
                                                    <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" OnRowCommand="mydetails_RowCommand"
                                                        ...
                                                        <Columns>
                                                          ...
                                                          <asp:TemplateField>
                                                                <ItemStyle Width="100px" HorizontalAlign="Center" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="pcdlbl" runat="server" Text='<%# Convert.ToDecimal(Eval("per_com7"))== -1? "N/A" : Eval("PCdate") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
            ...
            <div>
                <br />
                <h2 style="margin: 0">
                    Summary of CCTV Commissioning & Testing</h2>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" OnRowDataBound="mygridsumm_RowDataBound"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="QTY_PLANNED" HeaderText="PLANNED NO.OF POINTS" HeaderStyle-Font-Bold="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        </asp:BoundField>
