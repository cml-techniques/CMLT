<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casbmsreport_oph.aspx.cs" Inherits="CmlTechniques.CMS.casbmsreport_oph" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
     ...
     <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;height:26px">
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                        <asp:Label ID="lblhead" runat="server" Text="CAS ELV 2 - SCADA Commissioning Activity Schedule"></asp:Label>
                        </td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3579px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" colspan="15">COMMISSIONING &amp; TESTING</td>
        ...
        <td style="width:100px" align="center">POINT TO POINT TEST PLANNED</td>
        <td style="width:100px" align="center">POINT TO POINT TEST</td>
        <td style="width:100px" align="center">CALIBRATION/ FUNCTIONAL TEST PLANNED</td>
        ...
        <td style="width:100px" align="center">GRAPHICS/ HEAD END TEST PLANNED</td>
        ...
        <div style="position:relative;float:left;width:3579px">
