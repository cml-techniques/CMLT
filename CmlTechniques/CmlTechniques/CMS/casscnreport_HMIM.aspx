<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casscnreport_HMIM.aspx.cs" Inherits="CmlTechniques.CMS.casscnreport_HMIM" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
   ...
   <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;width:100%;height:26px">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2146px;height:80px" cellspacing="1" border="0" id="headTbl">
