...
{
    public partial class caslvreport : System.Web.UI.Page 
    {
        [Serializable]
        ...
        void setWeightage()
        {
            lblmdb.Text = "50-30-20% MDB";
         
            lblhcp.Text = "50-30-20% HCP";
            lblbushar.Text = "60-40% BUSBAR";
            lblsmdb.Text = "50-30-20% SMDB";

            lblmcc.Text = "50-30-20% MCC";
            lblats.Text = "50-30-20% ATS";
            lbldb.Text = "60-40% DB";
            lbllcp.Text = "60-40% LCP";
        ...
        private void Load_Master()
        {
            ...
            if (lblprj.Text == "11784" && (Request.QueryString["sch"] != null))
            {
                ...
                if (Request.QueryString["sch"].ToString() == "28")
                {
        ...
        protected void mygridsumm_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label _lbl1 = (Label)e.Row.Cells[5].FindControl("lbl1");
                    ...
                    if (lblprj.Text == "MOE" || lblprj.Text == "MOE1")
                {
                    ...
                    else if ((e.Row.Cells[12].Text == "DB") || (e.Row.Cells[12].Text == "EDB"))
                    {
                        _lbl1.Text = "N/A";
                        _q1 += 1;
                    }
                    else if (e.Row.Cells[12].Text == "UPS" || (e.Row.Cells[12].Text == "ATS"))
                    {
                        _lbl3.Text = "N/A";
                        _q3 += 1;
              ...
              if (lblprj.Text == "ASAO" || lblprj.Text == "ASAO1")
                ...
                //    if (e.Row.Cells[9].Text == "-1")
                //    {
                //        //Label lbl = (Label)e.Row.Cells[3].FindControl("lbl1");
                //        //lbl.Text = "N/A";
            ...
            try
            {
                ...
                foreach (var row in distinctRows)
                {
                    ...
                    foreach (var _row in _result)
                    {
                        ...
                        if (_row["devices1"] != null && _row["devices1"].ToString() != "" && _row["devices1"].ToString() != "TBC")
                        {
            ...
            try
            {
                ...
                foreach (var row in distinctRows)
                {
                    ...
                    //{
                        ...
                        else if (row.col3.ToString() == "DB" || row.col3.ToString() == "EDB")
                        {
                            if (lblprj.Text == "MOE" || lblprj.Text == "MOE1")
                            {
                        ...
                        {
                            if (lblprj.Text == "MOE" || lblprj.Text == "MOE1")_total = Decimal.Round((_per1), MidpointRounding.AwayFromZero);
                        }
                        else
                        {
                            if (_per2 == -1 && _per3 != -1)
