<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MsEntryHMHS.aspx.cs" Inherits="CmlTechniques.CMS.MsEntryHMHS" %>
...
<body>
    ...
    <telerik:RadWindow ID="RadWindow1" runat="server" Modal="true" BorderStyle="None"
        ...
        VisibleStatusbar="false" Skin="Metro" Width="500px" Height="230px">
        <ContentTemplate>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                    <ContentTemplate>
                                        <telerik:RadDropDownList ID="rd_Building" runat="server" OnSelectedIndexChanged="rd_Building_SelectedIndexChanged"
                                            ...
                                            AutoPostBack="true">
                                            <Items>
                                            <telerik:DropDownListItem Text="Hospital Building" Value="1" />
                                             <telerik:DropDownListItem Text="P1 Security Building " Value="2" />
                                              <telerik:DropDownListItem Text="Ring Road" Value="3" />
                                            </Items>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                    <ContentTemplate>
                                        <telerik:RadDropDownList ID="rd_Service" runat="server" Skin="Metro" RenderMode="Lightweight"
                                            DefaultMessage="Select Service" Width="350px"  AutoPostBack="true"
                                            OnSelectedIndexChanged="rd_Service_SelectedIndexChanged">
                                        </telerik:RadDropDownList>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                    <ContentTemplate>
                                        <telerik:RadDropDownList ID="rd_ms" runat="server" Skin="Metro" RenderMode="Lightweight" DefaultMessage="Select Ms Systems" Width="350px" DropDownHeight="200px"
                                            AutoPostBack="true">
                                        </telerik:RadDropDownList>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
