<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas5Areport.aspx.cs" Inherits="CmlTechniques.CMS.cas5Areport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <td style="width:100px" align="center" rowspan="2">PRE-COMM</td>
        <td style="width:100px" align="center" rowspan="2">COMMISSIONED</td>
        <td style="width:100px" align="center" rowspan="2">WITNESSED DATE</td>
        <td align="center" colspan="2">CONTROL SYSTEM</td>
        ...
        <td style="width:100px" align="center">COMMISSIONED</td>
        </tr>
        <tr bgcolor="#092443">
