<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas3Dreport.aspx.cs" Inherits="CmlTechniques.CMS.cas3Dreport" %>
...
<body>
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;width:3335px">
        <table >
                    <tr>
                        <td>
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.2.10 - Public Address and Mass Notification  System Commissioning Activity Schedule</td>
                    </tr>
                </table>
