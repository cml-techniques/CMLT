<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casfdreport_pcd.aspx.cs"
    Inherits="CmlTechniques.CMS.casfdreport_pcd" %>
<%@ Register
    ...
    <div style="font-family: verdana; font-size: xx-small; width: 100%">
        ...
        <div style="background-color: #092443; color: White; font-weight: bold; font-size: small;
            ...
            <table>
                <tr>
                    ...
                    <td style="font-weight: bold">
                        <asp:Label ID="lbltitle" runat="server" Text="CAS M3 Fusible Link Fire Dampers & MSFD Commissioning Activity Schedule"></asp:Label>
                    </td>
                           <td>
                            <asp:Label ID="lblpcd" runat="server" Text="Planned Reference Date"></asp:Label></td>
                        <td>
        ...
        <div id="HeaderDiv">
            <table style="font-family: Verdana; font-size: x-small; background-color: #9EB6CE;
                width: 2695px; height: 80px" cellspacing="1" border="0" id="headTbl" runat="server">
                <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
                    ...
                    <td style="width: 100px" align="center" rowspan="2" id="td_icom1" runat="server">
        ...
        <div id="DataDiv" style="overflow: scroll; background-color: #FFF" onscroll="Onscrollfnction();">
            <div style="position: relative; float: left; width: 2695px">
                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" Width="2695px"
                                                ...
                                                <td colspan="2">
                                                    <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" OnRowCommand="mydetails_RowCommand"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="per_com3" />
                                                        </Columns>
                                                    </asp:GridView>
                                                </td>
                                            </tr>
            ...
            <div>
                <br />
                <h2 style="margin: 0">
                    Summary of Commissioning and Testing</h2>
                <div>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" OnRowDataBound="mygridsumm_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="PLANNED COMPLETED" HeaderStyle-Font-Bold="false">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("PLANNED_COMPLETED")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="SATISFACTORILY TESTED" HeaderStyle-Font-Bold="false">
                                        ...
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("TESTED")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="WITNESSED" HeaderStyle-Font-Bold="false">
                                        ...
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("WITNESSED")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:BoundField DataField="PLANNED_PROGRESS" HeaderText="PLANNED OVERALL PROGRESS" HeaderStyle-Font-Bold="false">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="150px" />
                                    </asp:BoundField>
                                     <asp:BoundField DataField="ACTUAL_PROGRESS" HeaderText="ACTUAL OVERALL PROGRESS" HeaderStyle-Font-Bold="false">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="150px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CODE" />
                                    <asp:BoundField DataField="PLANNED_COMPLETED" />
                                    <asp:BoundField DataField="TESTED" />
                                    <asp:BoundField DataField="WITNESSED" />
                                    <asp:BoundField DataField="COUNT" />
                                    <asp:BoundField DataField="PCDCOUNT" />
