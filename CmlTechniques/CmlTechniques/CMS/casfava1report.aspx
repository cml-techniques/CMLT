<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casfava1report.aspx.cs" Inherits="CmlTechniques.CMS.casfava1report" %>
...
<body>
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;width:3282px">
        <table >
                    <tr>
                        <td>
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">CAS 3C - ELV - Fire Detection and Alarm System(FDAS) Commissioning Activity Schedule</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div style="position:relative;float:left;width:3282px">
        ...
        <td style="width:150px" align="center" rowspan="2">LOOP CIRCUIT NUMBER</td>
        ...
        <div >
            ...
            <br />
            <h2 style="margin:0">Summary of ELV Fire Detection and Alarm System Commissioning and Testing</h2>
            ...
            <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField ="TESTED" HeaderText="QTY" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
