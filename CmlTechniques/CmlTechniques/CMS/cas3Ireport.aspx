<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas3Ireport.aspx.cs" Inherits="CmlTechniques.CMS.cas3Ireport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.2.8 - Intercom Systems (Audio, Video and Healthcare) Commissioning Activity Schedule</td>
                    </tr>
                </table>
        ...
        <td style="width:100px" align="center" rowspan="2">NO.OF VIDEO STATION</td>
        ...
        <td style="width:100px" align="center" rowspan="2">SYSTEM FUNC. TEST AT MASTER 
            STATION</td>
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:TemplateField HeaderText="PRE-COMMSSIONED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="lblpcom" runat="server" Text='<%# Eval("PRE-COMM") %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>    
