<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="castrans1report.aspx.cs" Inherits="CmlTechniques.CMS.castrans1report" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold"> <asp:Label ID="lblhead" runat="server" Text=""></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:4000px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:150px" align="center" rowspan="2">PROVIDES POWER TO</td>
        <td style="width:150px" align="center" rowspan="2">FED FROM</td>
        <td style="width:100px" align="center" rowspan="2">SUBSTATION NUMBER</td>
        <td align="center" colspan="12">PANEL/EQUIPMENT SITE TESTING</td>
        <td align="center" colspan="4">OUTGOING CIRCUIT COLD TESTING</td>
        <td style="width:150px" align="center" rowspan="2">PFT (install) authority to 
            commence commissioning sign off</td>
        <td style="width:150px" align="center" rowspan="2">ENERGISATION DATE</td>
        <td style="width:150px" align="center" rowspan="2">FPT SIGN OFF [CML]</td>
        ...
        <td style="width:100px" align="center">WINDING IR TEST</td>
        <td style="width:100px" align="center">TAP CHANGER CHECK</td>
        <td style="width:100px" align="center">RATIO, VECTOR GROUP AND MAGNE. CURR. MEASU. 
            TEST</td>
        <td style="width:100px" align="center">MAGNETIC BALANCE TEST</td>
        <td style="width:100px" align="center">WINDING RESISTANCE TEST</td>
        <td style="width:100px" align="center">SHORT CIRCUIT TEST</td>
        <td style="width:100px" align="center">CALIBRATION OF TEMP. INDIC. AND RELAY TEST</td>
        <td style="width:100px" align="center">BUCHOLZ RELAY TEST</td>
        <td style="width:100px" align="center">TAN DELTA &amp; CAPACITANCE OF WINDING</td>
        <td style="width:100px" align="center">TRANSFORMER OIL ANALYSIS</td>
        <td style="width:100px" align="center">BUSHING CT TEST</td>
        <td style="width:100px" align="center">SITE PANEL TEST PROGRESS</td>
        <td style="width:100px" align="center">QUANTITY</td>
        <td style="width:100px" align="center">CABLE TESTED</td>
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="F_from">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("per_com2")+ "%"  %>' Width="100px" ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
        ...
        <div >
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:BoundField DataField="SYS_NAME" HeaderText="SYSTEM" HeaderStyle-Font-Bold="false" >
                    <HeaderStyle HorizontalAlign="Center" />
                ...
                <asp:TemplateField HeaderText="% COMPLETED" HeaderStyle-Font-Bold="false">
                 ...
                 <asp:TemplateField HeaderText="% COMPLETED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("CABLE")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="% OVERALL COMPLETE" HeaderStyle-Font-Bold="false">
                    ...
                    <asp:BoundField DataField="CABLE" />
