<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casbatterychargesreport.aspx.cs" Inherits="CmlTechniques.CMS.casbatterychargesreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold"> CAS Electrical Services. 48V DC Battery Chargers Commissioning Activity Schedule</td>
                    </tr>
                </table>
        ...
        <td style="width:100px" align="center" rowspan="2">NUMBER OF BATTERIES</td>
        <td style="width:100px" align="center" rowspan="2">
            NUMBER TESTED</td>
        <td style="width:100px" align="center" rowspan="2">FUNCTIONAL TEST</td>
         <td style="width:100px" align="center" rowspan="2">BATTERY DISCHARGE</td>
        ...
        <div >
            ...
            <br />
            <h2 style="margin:0">Summary of 48V DC Battery Chargers Commissioning Activity Schedule</h2>
            <div>
            <div >
             ...
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:TemplateField HeaderText="CABLE" HeaderStyle-Font-Bold="false">
                 ...
                 <asp:BoundField DataField ="PER_COMPLETED" HeaderText="COLD TEST" HeaderStyle-Font-Bold="false" > 
                    ...
                    <asp:BoundField DataField ="PER_COMPLETED1" HeaderText="NUMBER TESTED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>   
                    <asp:BoundField DataField ="PER_COMPLETED2" HeaderText="FUNCTIONAL TEST" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                     <asp:BoundField DataField ="PER_COMPLETED3" HeaderText="BATTERY DISCHARGE" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
            ...
            <%--<div style="width:250px;float:left" id="weighing" runat="server">
            <table>
            <tr>
