<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="caslv1report.aspx.cs" Inherits="CmlTechniques.CMS.caslv1report" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;height:80px;width:3897px" cellspacing="1" border="0" id="headTbl"  >
        ...
        <td align="center" colspan="8">PANEL/EQUIPMENT SITE TESTING</td>
        ...
        <td align="center" colspan="3">OUTGOING CIRCUIT LIVE TESTING</td>
        <td style="width:150px" align="center" rowspan="2">MECHANICAL PLANT FPT COMPLETED [CML]</td>
        ...
        <td style="width:100px" align="center">IR TEST (before and after HV test)</td>
        <td style="width:100px" align="center">PRESSURE TEST</td>
        <td style="width:100px" align="center">PRIMARY CURRENT INJECTION TEST</td>
        ...
        <td style="width:100px" align="center">COLD COMPLETE %</td>
        <td style="width:100px" align="center">COLD TEST COMPLETED DATE</td>
        <td style="width:100px" align="center">TOTAL LIVE TESTED</td>
        <td style="width:100px" align="center">LIVE COMPLETE %</td>
        <td style="width:100px" align="center">LIVE TEST COMPLETED DATE</td>
        </tr>
        <tr bgcolor="#092443">
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="F_from">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("per_com3")+ "%"  %>' Width="100px" ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
        ...
        <div >
            ...
            <br />
            <h2 style="margin:0">Summary Commissioning and Testing</h2>
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:TemplateField HeaderText="% COMPLETED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="lbpanel" runat="server" Text='<%# Eval("PANEL")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>    
                 <asp:TemplateField HeaderText="COLD TEST % COMPLETED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="lbcold" runat="server" Text='<%# Eval("COLD")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
                 <asp:TemplateField HeaderText="LIVE TEST % COMPLETED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="lblive" runat="server" Text='<%# Eval("LIVE")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>   
                 <asp:TemplateField HeaderText="COMMISSIONING & TESTING % COMPLETED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="lbcompl" runat="server" Text='<%# Eval("COMPLETED1")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
