<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casgen1report.aspx.cs" Inherits="CmlTechniques.CMS.casgen1report" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.1.4.2 - Generator Commissioning Activity Schedule</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3794px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" colspan="6">GENERATOR TESTING</td>
        <td align="center" rowspan="2">GENERATOR TEST COMPLETE</td>
        <td align="center" colspan="6">OUTGOING CIRCUIT TESTS</td>
        <td style="width:150px" align="center" rowspan="2">PFT (install) authority to 
            commence commissioning sign off [KEO]</td>
        ...
        <td style="width:100px" align="center">PRE-COM</td>
        <td style="width:100px" align="center">CONTROL/FUEL SYSTEM TEST</td>
        <td style="width:100px" align="center">INITIAL RUN TEST</td>
        <td style="width:100px" align="center">LOAD TEST</td>
        <td style="width:100px" align="center">FUNCTIONAL TEST</td>
        <td style="width:100px" align="center">FULL RUN TEST</td>
        <td style="width:100px" align="center">CONTINUITY TEST</td>
        <td style="width:100px" align="center">IR (before &amp; after HP)</td>
        <td style="width:100px" align="center">HP TEST</td>
        <td style="width:100px" align="center">COLD COMPLETE %</td>
        <td style="width:100px" align="center">CABLE TEST COMPLETE DATE</td>
        ...
        <div >
            ...
            <br />
            <h2 style="margin:0">Summary of Generator Commissioning and Testing</h2>
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:TemplateField HeaderText="% COMPLETED" HeaderStyle-Font-Bold="false">
                 ...
                 <asp:TemplateField HeaderText="CABLE TEST % COMPLETED" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                 ...
                 <asp:TemplateField HeaderText="OVERALL % COMPLETED" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
