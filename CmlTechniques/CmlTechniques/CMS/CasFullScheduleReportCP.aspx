<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CasFullScheduleReportCP.aspx.cs" Inherits="CmlTechniques.CMS.CasFullScheduleReportCP" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text="CAS CATHODIC PROTECTION Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
               
        </div>
        <div id="HeaderDiv" >
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2770px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">ROOM REF</td>
        <td style="width:100px" align="center" rowspan="2">ROOM TYPE</td>
        <td style="width:100px" align="center" rowspan="2">CONTINUITY</td>
        <td style="width:100px" align="center" rowspan="2">PRECOM</td>
        <td style="width:100px" align="center" rowspan="2">INITIAL VERIFICATION</td>
        <td style="width:100px" align="center" rowspan="2">PERFORMANCE VERIFICATION</td>
        <td align="center" colspan="6">TEST REPORTS</td>
       ...
       <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
        ...
        <td style="width:100px" align="center">WIN REF</td>
        <td style="width:100px" align="center">DATE</td>
        <td style="width:100px" align="center">STATUS</td>
        <td style="width:100px" align="center">CML WITNESSED</td>
        <td style="width:100px" align="center">CONSULTANT ACCEPTE</td>
      ...
      <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
        <td style="width:100px" align="center"><asp:UpdatePanel ID="UpdatePanel16" runat="server">
                 <ContentTemplate>
                 <asp:Button ID="btnexpand" runat="server" Text="Expand All" Width="98%"
        ...
        <td style="width:100px" align="center"><asp:UpdatePanel ID="UpdatePanel17" runat="server">
                 <ContentTemplate>
                 <asp:Button ID="btncollapse" runat="server" Text="Collapse All" Width="98%" 
        ...
        <div style="position:relative;float:left;width:2770px">
            ...
            <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" 
                Width="2700px" onrowdatabound="mymaster_RowDataBound" 
                Font-Names="Verdana" 
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of Cathodic protection Commissioning and Testing</h2>
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField ="TESTED" HeaderText="PRECOM" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField> 
                  <asp:BoundField DataField ="TESTED1" HeaderText="CONTINUITY" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                    <asp:BoundField DataField ="TESTED2" HeaderText="INITIAL VERIFICATION" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>   
                    <asp:BoundField DataField ="TESTED3" HeaderText="PERFORMANCE VERIFICATION" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>      
