<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas3Mreport.aspx.cs" Inherits="CmlTechniques.CMS.cas3Mreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">CAS 3M - ELV - Intercom &amp; Healthcare Communication and Monitoring (IHCM) System Commissioning Activity Schedule</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2820px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">SERVER/ PANEL ENERGISATION DATE</td>
        <td align="center" colspan="3">PRE-COMMISSIONING</td>
        <td align="center" colspan="3">COMMISSIONING</td>
        ...
        <td style="width:100px" align="center">INSTALLATION CHECK</td>
        <td style="width:100px" align="center">% COMPLETE</td>
        <td style="width:100px" align="center">FUNCTIONAL TEST</td>
        <td style="width:100px" align="center">INTEGRATION/ INTERFACE TEST</td>
        <td style="width:100px" align="center">% COMPLETE</td>
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="Loc" >
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("per_com2")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
        ...
        <div >
            ...
            <br />
            <h2 style="margin:0">Summary of ELV Intercom &amp; Healthcare Communication and Monitoring System Commissioning and Testing</h2>
            <div >
