<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casfavareport3.aspx.cs" Inherits="CmlTechniques.CMS.casfavareport3" %>
    ...
    <div  style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                ...
                <asp:Label ID="lbldiv" runat="server" Text="" style="display:none"></asp:Label>
                 <asp:Label ID="lblfacid" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3067px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:200px" align="center">
         <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                <ContentTemplate>
                <asp:DropDownList ID="drfed" runat="server" Width="100%" AutoPostBack="true" 
                        onselectedindexchanged="drfed_SelectedIndexChanged" >
                </asp:DropDownList>
