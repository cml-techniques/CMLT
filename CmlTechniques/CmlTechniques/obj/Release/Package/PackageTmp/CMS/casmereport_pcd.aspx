<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casmereport_pcd.aspx.cs"
    Inherits="CmlTechniques.CMS.casmereport_pcd" %>
    ...
    <div style="font-family: verdana; font-size: xx-small; width: 100%">
            ...
            <table>
                <tr>
                    ...
                    <td style="font-weight: bold; color: #fff">
                        <asp:Label ID="lblhead" runat="server" Text="CAS M1 Mechanical Services Commissioning Activity Schedule "></asp:Label>
                    </td>
                    <td>
        ...
        <div id="HeaderDiv">
            <table style="font-family: Verdana; font-size: x-small; background-color: #9EB6CE;
                width: 2973px; height: 80px" cellspacing="1" border="0" id="headTbl">
        ...
        <div id="DataDiv" style="overflow: scroll; background-color: #FFF" onscroll="Onscrollfnction();">
            <div style="position: relative; float: left; width: 2973px">
                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" Width="2973px"
                            OnRowDataBound="mymaster_RowDataBound" Font-Names="Verdana" Font-Size="X-Small"
                            ShowHeader="False" GridLines="None">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <table id="inner_table" width="2973px">
                                            <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
                                                <td style="width: 50px">
                                                    <asp:Button ID="Button1" runat="server" Text="-" CommandArgument="Button1" OnClick="Button1_Click"
                                                        Width="30px" Style="cursor: pointer" />
                                                </td>
                                                <td style="font-weight: bold; width: 2973px" align="left">
                                                    ...
                                                    <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" OnRowCommand="mydetails_RowCommand"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label runat="server" Text='<%# BindPlannedNA(Eval("per_com1"),Eval("PCdate"))%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField>
                                                                <ItemStyle HorizontalAlign="Center" Width="100px" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Label2" runat="server" Text='<%# BindPlannedNA(Eval("per_com2"),Eval("PCdate1"))%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
            ...
            <div>
                <br />
                <h2 style="margin: 0">
                    Summary of Mechanical Commissioning and Testing</h2>
                <div>
                        ...
                        <ContentTemplate>               
                            <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" OnRowCreated="mygridsumm_RowCreated"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Qty Planned" HeaderStyle-Font-Bold="false">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("PER_COMPLETED3")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="% Planned" HeaderStyle-Font-Bold="false">
                                        ...
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# (Eval("PLANNED_PER_PCOM")== "N/A")?"N/A":Eval("PLANNED_PER_PCOM")+ "%" %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Qty Complete" HeaderStyle-Font-Bold="false">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="% Actual Progress" HeaderStyle-Font-Bold="false">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# (Eval("ACTUAL_PER_PCOM")== "N/A")?"N/A":Eval("ACTUAL_PER_PCOM") + "%" %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Qty Planned" HeaderStyle-Font-Bold="false">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("PER_COMPLETED4")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="% Planned" HeaderStyle-Font-Bold="false">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# (Eval("PLANNED_PER_COM")== "N/A")?"N/A":Eval("PLANNED_PER_COM")+ "%" %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Qty Complete" HeaderStyle-Font-Bold="false">
                                        <HeaderStyle HorizontalAlign="Center" />
                                    ...
                                    <asp:TemplateField HeaderText="% Actual Progress" HeaderStyle-Font-Bold="false">
                                        ...
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# (Eval("ACTUAL_PER_COM")== "N/A")?"N/A":Eval("ACTUAL_PER_COM")+ "%" %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Planned Overall Progress" HeaderStyle-Font-Bold="false">
                                        ...
                                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# (Eval("TOTAL1") == "N/A")?"N/A":Eval("TOTAL1")+ "%" %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:BoundField DataField="PER_COMPLETED3" />
                                    <asp:BoundField DataField="PLANNED_PER_PCOM" />
                                    <asp:BoundField DataField="PER_COMPLETED" />
                                    <asp:BoundField DataField="ACTUAL_PER_PCOM" />
                                    <asp:BoundField DataField="PER_COMPLETED4" />
                                    <asp:BoundField DataField="PLANNED_PER_COM" />
                                    <asp:BoundField DataField="PER_COMPLETED1" />
                                    <asp:BoundField DataField="ACTUAL_PER_COM" />
                                    <asp:BoundField DataField="TOTAL1" />
                                    <asp:BoundField DataField="TOTAL" />
                                    <asp:BoundField DataField="PCOMM_NA" />
                                    <asp:BoundField DataField="COMM_NA" />
                                    <asp:BoundField DataField="PCOMM" />
                                    <asp:BoundField DataField="COMM" />
                                </Columns>
                            </asp:GridView>
                            <input type="hidden" runat="server" id="hdnPLpcom" value="" />
                            <input type="hidden" runat="server" id="hdnPLpcomper" value="" />
                            <input type="hidden" runat="server" id="hdnACpcom" value="" />
                            <input type="hidden" runat="server" id="hdnACpcomper" value="" />
                            <input type="hidden" runat="server" id="hdnPLcom" value="" />
                            <input type="hidden" runat="server" id="hdnPLcomper" value="" />
                            <input type="hidden" runat="server" id="hdnACcom" value="" />
                            <input type="hidden" runat="server" id="hdnACcomper" value="" />
