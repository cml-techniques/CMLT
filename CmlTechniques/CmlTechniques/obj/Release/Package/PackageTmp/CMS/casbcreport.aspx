<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casbcreport.aspx.cs" Inherits="CmlTechniques.CMS.casbcreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">CAS Electrical Services Commissioning Activity Schedule (Battery Charger)</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2611px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:150px" align="center" rowspan="2">ENG.REF</td>
        ...
        <td style="width:200px" align="center" rowspan="2">PROVIDES POWER TO</td>
        <td align="center" rowspan="2">INSTALLATION SIGN OFF</td>
        <td align="center" colspan="4">BATTERY TESTING</td>
        <td align="center" rowspan="2">DC SYSTEM TEST COMPLETE</td>
        <td align="center" rowspan="2" >CONSULTANT ACCEPTED</td>
        <td rowspan="2" style="text-align: center">TEST SHEETS FILED</td>
        ...
        <td align="center" >BATTERY CHARGING</td>
        <td align="center" >BATTERY DISCHARGING</td>
        <td align="center" >BATTERY RECHARGING</td>
        <td align="center" >FUNCTIONAL TEST</td>
        </tr>
        <tr bgcolor="#092443">
        ...
        <div style="position:relative;float:left;width:2611px">
            ...
            <div>
            <br />
            <h2 style="margin:0">Summary of Battery Charger Commissioning Activity Schedule</h2>
            <div>
