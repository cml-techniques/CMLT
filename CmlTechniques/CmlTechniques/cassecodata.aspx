<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cassecodata.aspx.cs" Inherits="CmlTechniques.cassecodata" %>
        ...
        <table style="font-family: verdana; font-size: x-small; width: 100%; height: 100%">
            ...
            <tr>
                ...
                <div id="forPrint" runat="server">
                    <asp:ListView ID="my_in_view" runat="server" style="width:100%" 
                        DataKeyNames="cas_id,itm_no" onitemediting="my_in_view_ItemEditing" 
                        onitemcommand="my_in_view_ItemCommand" 
                        onitemupdating="my_in_view_ItemUpdating" >
                        <ItemTemplate>
