<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cassheet_DataEntryCP.aspx.cs" Inherits="CmlTechniques.Cassheet_DataEntryCP" %>
    ...
    <div style="font-family: verdana; font-size: x-small;height:100%;position:fixed;width:100%">
       ...
       <tr  style="background-image: url('images/head_bg.png'); background-repeat: repeat-x;">
                            ...
                            <td align="center" colspan="4" valign="middle"  >
                                ASSET CODE</td>
                            <td align="center" rowspan="2" valign="middle" width="15%" id="td_lblarea" runat="server" >
                                <asp:Label ID="lblare" runat="server" Text="AREA"></asp:Label></td>
                            <td align="center" rowspan="2" valign="middle" width="15%" id="td_lbl0" runat="server" >
                                <asp:Label ID="lbloc" runat="server" Text="LOCATION"></asp:Label>
                            </td>
                            <td align="center" rowspan="2" valign="middle" width="11%" id="td_lblroomref" runat="server" >
                                <asp:Label ID="lbl3" runat="server" Text="Room Ref" ></asp:Label></td>
                            <td align="center" rowspan="2" valign="middle" width="11%" id="td_lblroomtype" runat="server" >
                                <asp:Label ID="lbl1" runat="server" Text="Room Type"></asp:Label></td>
                        </tr>
                        <tr style="background-image: url('images/head_bg.png'); background-repeat: repeat-x;">
            ...
            <td id="td_txtroomref" runat="server">
                                <asp:TextBox ID="txtroomref" runat="server" Width="94%" 
                                    ></asp:TextBox>
                                            </td>
            <td id="td_txtroomtype" runat="server">
                                <asp:TextBox ID="txtroomtype" runat="server" Width="94%" 
                                    ></asp:TextBox>
                                            </td>
<%--            <td id="td_txtdes" runat="server">
        ...
        <%--<div class="accordion-inner" style="display: none;">--%>
                <asp:GridView ID="mydetails" runat="server" ShowHeader="false" AutoGenerateColumns="false" Width="100%" OnRowCommand="mydetails_RowCommand" OnRowDataBound="mydetails_RowDataBound" Font-Names="Verdana" GridLines="Both"
                    Font-Size="X-Small">
                <Columns>
                ...
                <asp:BoundField DataField="Seq_No" HeaderText="Seq.No" ItemStyle-Width="7%" >
                    ...
                    <asp:BoundField DataField="Des" HeaderText="Room Ref"  ItemStyle-Width="11%"  >
                    <ItemStyle Width="11%" HorizontalAlign="Center" />
                     </asp:BoundField>
                     <asp:BoundField DataField="Substation" HeaderText="Room Type"  ItemStyle-Width="11%"  >
                    <ItemStyle Width="11%" HorizontalAlign="Center" />
                     </asp:BoundField>
            ...
            <div>
                ...
                <td width="250px">ENG.REF</td>
                    ...
                    <tr id="tr2" runat="server">
                        <td width="150px">
                            <asp:Label ID="lbroomref" runat="server" Text="ROOM REF></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="uplroomref" runat="server" Width="150px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr id="tr3" runat="server">
                        <td width="150px">
                            <asp:Label ID="lb1roomtype" runat="server" Text="ROOM TYPE"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="uproomtype" runat="server" Width="150px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td width="150px">
