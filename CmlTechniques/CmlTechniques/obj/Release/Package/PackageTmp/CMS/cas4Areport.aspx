<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas4Areport.aspx.cs" Inherits="CmlTechniques.CMS.cas4Areport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    <form id="form1" runat="server">
     <div style="font-family: verdana; font-size: xx-small">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3329px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" colspan="7">MECHANICAL SYSTEM</td>
        <td align="center" colspan="2">CONTROLS</td>
        ...
        <td style="width:100px" align="center">DESIGN VOLUME l/s</td>
        <td style="width:100px" align="center">OBTAINED VOLUME l/s</td>
        ...
        <div >
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:BoundField DataField ="PRE-COMM" HeaderText="TOTAL PRE- COMMISSIONED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>    
                <%--<asp:TemplateField HeaderText="PRE-COMMSSIONED" HeaderStyle-Font-Bold="false">
                    ...
                    <asp:BoundField DataField ="COMM" HeaderText="TOTAL COMMISSIONED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>  
                 <%--<asp:TemplateField HeaderText="COMMISSIONED" HeaderStyle-Font-Bold="false">
                    ...
                    <asp:BoundField DataField ="WIT" HeaderText="TOTAL WITNESSED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
