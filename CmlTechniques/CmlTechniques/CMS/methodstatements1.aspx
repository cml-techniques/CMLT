<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="methodstatements1.aspx.cs" Inherits="CmlTechniques.CMS.methodstatements1" %>
    ...
    <script type="text/javascript">
        function calldoc(type, id, file) {
            ...
            if (type == 1) {
                ...
                var prm = "prj=" + _prj.textContent + "&mode=MS&doc=" + id  + "&id="+ getQueryStringValue("id")+ "&Div="+ getQueryStringValue("Div");
                //Session["viewmode"] = "CP";
...
<body>
    ...
    <asp:Label ID="lblfpath" runat="server" Text="" Style="display: none"></asp:Label>
     ...
     <div id="doc_list">
             ...
             <div id="thead">
        <div class="titles">
         <asp:Label ID="phead" runat="server" Text="Method Statement" ></asp:Label>
        </div>
        <div class="btns">
