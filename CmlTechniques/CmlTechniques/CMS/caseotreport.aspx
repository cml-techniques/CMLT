<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="caseotreport.aspx.cs" Inherits="CmlTechniques.CMS.caseotreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lblhead" runat="server" Text="CAS MISC6 EOT Crane Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2976px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" colspan="5">ELECTRICAL TESTING</td>
        <td align="center" colspan="4">LIFE &amp; SAFETY FUNCTIONAL TESTS</td>
        ...
        <td align="center">COLD POWER CABLE TESTING</td>
        <td align="center">LIVE POWER CABLE TESTING</td>
        <td align="center">COLD BUS RAIL TESTING</td>
        <td align="center">LIVE BUS RAIL TESTING</td>
        <td align="center">WITNESS OF COLD &amp; LIVE TESTING</td>
        <td align="center">COMM. APPROVED</td>
        <td align="center">LOAD TESTS</td>
        <td align="center">SAFETY LINK SWITCH &amp; ANTI COLLISION TESTS</td>
        <td align="center">FLOOD LIGHT &amp; EMERGENCY LIGHT TESTS</td>
        <td align="center">TESTED &amp; COMM.</td>
        <td align="center">3RD PARTY INSPECTED</td>
