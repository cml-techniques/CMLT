<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casemg1report.aspx.cs" Inherits="CmlTechniques.CMS.casemg1report" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.1.6 - Central Battery Emergency Lighting Commissioning Activity Schedule</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3382px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" colspan="3">CIRCUIT IR TESTING</td>
        <td align="center" colspan="7">OUTGOING CIRCUIT COLD TESTING</td>
        <td align="center" rowspan="2">CBS % COMPLETE</td>
        ...
        <td style="width:100px" align="center">TOTAL IR TESTED</td>
        <td style="width:100px" align="center">IR TEST COMPLETE</td>
        <td style="width:100px" align="center">NO.OF LAMPS</td>
        <td style="width:100px" align="center">DEVICE ADDRESSING TEST</td>
        <td style="width:100px" align="center">SOFTWARE PROGRAMMING</td>
        <td style="width:100px" align="center">PANEL FUNCT. TEST</td>
        <td style="width:100px" align="center">LIGHTING LUX LEVEL TEST</td>
        <td style="width:100px" align="center">BATTERY DISCHARGE TEST</td>
        <td style="width:100px" align="center">GRAPHICS TEST</td>
        </tr>
        <tr bgcolor="#092443">
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="F_from">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("per_com2")+ "%"  %>' Width="100px" ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>                
        ...
        <div >
            ...
            <br />
            <h2 style="margin:0">Summary of Central Battery System Commissioning and Testing</h2>
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:TemplateField HeaderText="PANEL TESTED" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Labelp" runat="server" Text='<%# Eval("PANEL")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
                 <asp:BoundField DataField ="QTY1" HeaderText="TOTAL CIRCUITS" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                 <asp:BoundField DataField ="COLD" HeaderText="COLD TESTED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>          
                 <asp:TemplateField HeaderText="% COMPLETED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Labelc" runat="server" Text='<%# Eval("CIRCUIT")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="% OVERALL COMPLETE" HeaderStyle-Font-Bold="false">
                    ...
                    <asp:BoundField DataField="CIRCUIT" />
                    <asp:BoundField DataField="CIRCUIT" />
