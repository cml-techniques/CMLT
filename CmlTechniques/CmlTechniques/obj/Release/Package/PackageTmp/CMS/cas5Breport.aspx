<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas5Breport.aspx.cs" Inherits="CmlTechniques.CMS.cas5Breport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.4.16 - Pneumatic Tube System Commissioning Activity Schedule</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3535px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:150px" align="center" rowspan="2">FED FROM (System Component)</td>
        <td style="width:150px" align="center" rowspan="2">FED FROM (Electrical)</td>
        <td style="width:100px" align="center" rowspan="2">TOTAL NO. INSTALLATION COMPLETION 
            SIGNED OFF</td>
        <td style="width:100px" align="center" rowspan="2">TOTAL NO. PFT COMPLETION SIGNED 
            OFF</td>
        <td style="width:100px" align="center" rowspan="2">PLANT START UP COMPLETE</td>
        <td align="center" colspan="3">MECHANICAL SYSTEM</td>
        <td align="center" colspan="4">MECHANICAL SYSTEM</td>
        ...
        <td style="width:100px" align="center" rowspan="2">GRAPHICS/ HEAD END TEST</td>
        <td style="width:100px" align="center" rowspan="2">3 MONTHS EVALUATION</td>
        <td style="width:100px" align="center" rowspan="2">6 MONTHS EVALUATION</td>
        ...
        <td style="width:100px" align="center">OPERATIONAL TEST</td>
        <td style="width:100px" align="center">ACCEPTANCE TEST</td>
        <td style="width:100px" align="center">RELIABILITY TEST</td>
        <td style="width:100px" align="center">COMPLETION OF ACCEPTANCE TESTING</td>
        </tr>
        <tr bgcolor="#092443">
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:BoundField DataField ="QTY" HeaderText="QUANTITY" HeaderStyle-Font-Bold="false" > 
                    ...
                    <asp:TemplateField HeaderText="PRE- COMMISSIONED" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
