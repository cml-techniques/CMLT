<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="caselp1report.aspx.cs" Inherits="CmlTechniques.CMS.caselp1report" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.1.1 Earthing and Lightning Protection Commissioning Activity Schedule</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2714px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:150px" align="center" rowspan="2">PROVIDES EARTHING TO</td>
        <td align="center" rowspan="2">EARTH PIT TEST</td>
        <td align="center" rowspan="2">CONTINUITY TEST OF REBARS/ CONDUCTOR</td>
        <td align="center" rowspan="2">BONDING OF ALL EQUIPMENT COMPLETE</td>
        <td align="center" rowspan="2">EARHING SYSTEM COMPLETE</td>
        ...
        <div >
            ...
            <br />
            <h2 style="margin:0">Summary of Earthing &amp; Lightning Protection Commissioning and Testing</h2>
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ...
                <asp:BoundField DataField ="QTY" HeaderText="QUANTITY" HeaderStyle-Font-Bold="false" > 
                    ...
                    <asp:BoundField DataField ="QTY" HeaderText="SYSTEM" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                <asp:TemplateField HeaderText="PITS" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("PITS")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>    
                 <asp:TemplateField HeaderText="CONTINUITY" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("CONTINUITY")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
                 <asp:TemplateField HeaderText="BONDING COMPLETE" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("BONDING")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>   
                 ...
                 <asp:TemplateField HeaderText="% OVERALL COMPLETE" HeaderStyle-Font-Bold="false">
                    ...
                    <asp:BoundField DataField="QPITS" />
                    <asp:BoundField DataField="QCONT" />
                    <asp:BoundField DataField="QBOND" />
