<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casacsreport_oph.aspx.cs" Inherits="CmlTechniques.CMS.casacsreport_oph" %>
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold"><asp:Label ID="lblhead" runat="server" Text="CAS ELV3 Access Control System Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
