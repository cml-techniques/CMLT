...
{
    public partial class casph3report : System.Web.UI.Page
    {
        ...
        private void Load_Master()
        {
            ...
            if (lblprj.Text == "11784" && (Request.QueryString["sch"] != null))
            {
                ...
                if (Request.QueryString["sch"].ToString() == "40")
                {
        ...
        protected void mygridsumm_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[3].Text = (Decimal.Round((_total / _count),MidpointRounding.AwayFromZero)).ToString() + '%';
            }
        }
        protected void print_Click(object sender, EventArgs e)
        {
            ...
            _path = "Cas_Report.aspx?id=19_P" + lblprj.Text + "_B" + drbuilding.SelectedItem.Value + "_F" + drflevel.SelectedItem.Value + "_C" + drcategory.SelectedItem.Value + "_D" + drfed.SelectedItem.Value + "_Z" + (string)Session["zero"] + "&Div=" + lbldiv.Text;
