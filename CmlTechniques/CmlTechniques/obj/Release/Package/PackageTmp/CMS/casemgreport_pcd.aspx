<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casemgreport_pcd.aspx.cs" Inherits="CmlTechniques.CMS.casemgreport_pcd" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text="CAS E6 Electrical Services. Emergency Lighting Commissioning Activity Schedule"></asp:Label>
                            </td>
                           <td>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2461px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">
            <asp:Label ID="lblnotitle" runat="server" Text="NO.OF EMERGENCY LIGHTS"></asp:Label></td>
        <td style="width:100px" align="center" rowspan="2">PLANNED COMPLETION </td>
        <td style="width:100px" align="center" rowspan="2">CONTINUITY/<br />
&nbsp;IR TEST</td>
        <td style="width:100px" align="center" rowspan="2">ADDRESSING</td>
        <td style="width:100px" align="center" rowspan="2">FAULT TESTING</td>
        <td style="width:100px" align="center" rowspan="2">CHANGE OVER TEST</td>
        <td style="width:100px" align="center" rowspan="2">LUX LEVEL TEST</td>
        <td style="width:100px" align="center" rowspan="2">DURATION TEST</td>
        <td style="width:100px" align="center" rowspan="2">PC HEAD END TEST</td>
        <td style="width:100px" align="center" rowspan="2">CONSULTANT ACCEPTED</td>
        <td style="width:100px" align="center" rowspan="2">TEST SHEETS FILED</td>
        ...
        <div style="position:relative;float:left;width:2461px">
            ...
            <div>
            <br />
            <h2 style="margin:0">Summary of Emergency Lighting Commissioning &amp; Testing</h2>
