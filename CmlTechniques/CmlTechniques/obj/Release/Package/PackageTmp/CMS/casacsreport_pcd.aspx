<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casacsreport_pcd.aspx.cs" Inherits="CmlTechniques.CMS.casacsreport_pcd" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
       <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold"><asp:Label ID="lblhead" runat="server" Text="CAS ELV3 Access Control System Commissioning Activity Schedule"></asp:Label>
                        //
                        </td>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2764px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" colspan="8">COMMISSIONING &amp; TESTING</td>
        ...
        <td align="center" class="style1">ADDRESSING/ PROGRAMMING TEST</td>
        <td align="center" class="style1">FAULT &amp; ALARM TEST</td>
        <td align="center" class="style1">ACCESS CARD SWIPE</td>
        <td align="center" class="style1">POWER FAILURE TEST</td>
        <td align="center" class="style1">INTERFACE TEST</td>
        <td align="center" class="style1">PC HEADEND/ GRAPHICS TEST</td>
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="Loc" >
                    ...
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("per_com8")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
