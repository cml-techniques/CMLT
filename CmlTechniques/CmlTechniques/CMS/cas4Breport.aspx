<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas4Breport.aspx.cs" Inherits="CmlTechniques.CMS.cas4Breport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3841px;height:80px;" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">LOAD</td>
        <td style="width:100px" align="center" rowspan="2">STARTER TYPE</td>
        <td style="width:100px" align="center" rowspan="2">DUTY (VOLUME/ US GPM)</td>
        <td style="width:100px" align="center" rowspan="2">DUTY (PRESSURE)</td>
        ...
        <td align="center" colspan="2">ROOM INTEGRITY REST</td>
        <td style="width:100px" align="center" rowspan="2">PFT(INSTALLATION) COMPLETION SIGN OFF 
            [KEO]</td>
        <td style="width:100px" align="center" rowspan="2">PFT (OPERATION) COMPLETION SIGN 
            OFF</td>
        <td style="width:100px" align="center" rowspan="2">PLANT STAR UP COMPLETE CONTRACTOR</td>
        <td align="center" colspan="5">FIRE PROTECTION SYSTEM</td>
        <td align="center">INTERFACING</td>
        ...
        <td style="width:100px" align="center">RETENTION TIME AT MIN.HEIGHT (MINUTES)</td>
        <td style="width:100px" align="center">PRE-COMM</td>
        <td style="width:100px" align="center">COMM</td>
        <td style="width:100px" align="center">DESIGN VOLUME</td>
        <td style="width:100px" align="center">OBTAINED %</td>
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="Seq_No" >
                    ...
                    <asp:BoundField DataField="S_c_m" >
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                    </asp:BoundField>
        ...
        <div >
            ...
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowcreated="mygridsumm_RowCreated" 
                ShowFooter="true" onrowdatabound="mygridsumm_RowDataBound">
                ...
                <asp:BoundField DataField ="PRE-COMM" HeaderText="QTY" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>    
                <asp:TemplateField HeaderText="% TESTED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("PRE-COMMT")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>  
                    <asp:BoundField DataField ="COMM" HeaderText="QTY" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                 ...
                 <asp:TemplateField HeaderText="% TESTED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("COMMT")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField ="WIT" HeaderText="QTY" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="% TESTED" HeaderStyle-Font-Bold="false">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("WITT")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="% OVERALL COMPLETE" HeaderStyle-Font-Bold="false">
                    ...
                    <%--<asp:BoundField DataField="PRE-COMMT" />
                    <asp:BoundField DataField="COMMT" />
