<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casictreport.aspx.cs" Inherits="CmlTechniques.CMS.casictreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
            ...
            <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                        ...
                        <td style="font-weight: bold"><asp:Label ID="lblhead" runat="server" Text="CAS ELV8 - Information and Communication Technology (ICT) Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <td style="width:200px" align="center" rowspan="2">CONNECTED TO</td>
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of ICT Commissioning and Testing</h2>
