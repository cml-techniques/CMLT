<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="caslcsreport_pcd.aspx.cs" Inherits="CmlTechniques.CMS.caslcsreport_pcd" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
      ...
      <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;width:100%;height:26px">
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lblhead" runat="server" Text="CAS ELV5 Lighting Control System Commissioning Activity Schedule"></asp:Label></td>
                                          <td style="width:5px">
                            //
                            </td>
                            <td>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2286px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:200px" align="center" rowspan="2">AREA SERVED</td>
        <td style="width:100px" align="center" rowspan="2">NO.OF CIRCUITS</td>
        <td align="center" rowspan="2">PLANNED COMPLETION DATE</td>
        <td align="center" rowspan="2">CONTINUITY/ IR TESTED</td>
        <td align="center" rowspan="2">NO.OF LIGHTING CIRCUITS TESTED</td>
        <td align="center" rowspan="2">NO.OF LIGHTING SCENES</td>
        <td align="center" rowspan="2">ADDRESSING/ PROGRAMMING TEST</td>
        <td align="center" rowspan="2">PC HEADEND/ INTERFACE TEST</td>
        ...
        <div style="position:relative;float:left;width:2286px">
            ...
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                Font-Names="Verdana" 
                Font-Size="X-Small" ShowHeader="false" Width="2286px" >
                <Columns>
                <asp:BoundField>
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of Lighting Control Commissioning and Testing</h2>
