<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casflureport_pcd.aspx.cs"
    Inherits="CmlTechniques.CMS.casflureport_pcd" %>
    ...
    <div style="font-family: verdana; font-size: xx-small; width: 100%">
        ...
        <div style="background-color: #092443; color: White; font-weight: bold; font-size: small;
            ...
            <table>
                <tr>
                    ...
                    <td style="font-weight: bold">
                        <asp:Label ID="lblhead" runat="server" Text="CAS M2 Flushing Commissioning Activity Schedule"></asp:Label>
                    </td>
                    <td>
        ...
        <div id="HeaderDiv">
            <table style="font-family: Verdana; font-size: x-small; background-color: #9EB6CE;
                width: 2810px; height: 80px" cellspacing="1" border="0" id="headTbl">
        ...
        <div id="DataDiv" style="overflow: scroll; background-color: #FFF" onscroll="Onscrollfnction();">
            <div style="position: relative; float: left; width: 2810px">
                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" Width="2810px"
                            OnRowDataBound="mymaster_RowDataBound" Font-Names="Verdana" Font-Size="X-Small"
                            ShowHeader="False" GridLines="None">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <table id="inner_table" width="2810px">
                                            <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
                                                <td style="width: 50px">
                                                    <asp:Button ID="Button1" runat="server" Text="-" CommandArgument="Button1" OnClick="Button1_Click"
                                                        Width="30px" Style="cursor: pointer" />
                                                </td>
                                                <td style="font-weight: bold; width: 2810px" align="left">
                                                    ...
                                                    <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" OnRowCommand="mydetails_RowCommand"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                <ItemStyle Width="100px" HorizontalAlign="Center" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="pcdlbl" runat="server" Text='<%# Convert.ToDecimal(Eval("per_com1"))== -1 || Convert.ToDecimal(Eval("per_com2"))== -1 ? "N/A" : Eval("PCdate") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
            ...
            <div>
                <br />
                <h2 style="margin: 0">
                    Summary of Flushing Commissioning and Testing</h2>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" OnRowDataBound="mygridsumm_RowDataBound"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="SYS_NAME" HeaderText="EQUIPMENTS" HeaderStyle-Font-Bold="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                        ...
                                        <asp:TemplateField HeaderText="Plain Flushing" HeaderStyle-Font-Bold="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Width="100px" />
                                            <ItemTemplate>
                                                <asp:Label ID="Label1" runat="server" Text='<%# (Eval("PLAIN_FLUSH")== "N/A")?"N/A":Eval("PLAIN_FLUSH")+ "%"  %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Flushing Velocities Recorded" HeaderStyle-Font-Bold="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Width="100px" />
                                            <ItemTemplate>
                                                <asp:Label ID="Label1" runat="server" Text='<%# (Eval("FLUSH_VELOCITY")== "N/A")?"N/A":Eval("FLUSH_VELOCITY")+ "%"  %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Chemical Cleaning" HeaderStyle-Font-Bold="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Width="100px" />
                                            <ItemTemplate>
                                                <asp:Label ID="Label1" runat="server" Text='<%# (Eval("CHEMICAL_CLEAN")== "N/A")?"N/A":Eval("CHEMICAL_CLEAN")+ "%"  %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Flush after Chemical Cleaning" HeaderStyle-Font-Bold="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Width="100px" />
                                            <ItemTemplate>
                                                <asp:Label ID="Label1" runat="server" Text='<%# (Eval("FLUSH_AFTERCHEM")== "N/A")?"N/A":Eval("FLUSH_AFTERCHEM")+ "%"  %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Back Flushing Complete" HeaderStyle-Font-Bold="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Width="100px" />
                                            <ItemTemplate>
                                                <asp:Label ID="Label1" runat="server" Text='<%# (Eval("BACK_FLUSH")== "N/A")?"N/A":Eval("BACK_FLUSH")+ "%"  %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Final Chemical Treatment" HeaderStyle-Font-Bold="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Width="100px" />
                                            <ItemTemplate>
                                                <asp:Label ID="Label1" runat="server" Text='<%# (Eval("CHEMICAL_TREATMENT")== "N/A")?"N/A":Eval("CHEMICAL_TREATMENT")+ "%"  %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Planned Overall Progress" HeaderStyle-Font-Bold="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Width="100px" />
                                            <ItemTemplate>
                                                <asp:Label ID="Label1" runat="server" Text='<%# (Eval("PLANNED_PROGRESS")== "N/A")?"N/A":Eval("PLANNED_PROGRESS")+ "%"  %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Actual Overall Progress" HeaderStyle-Font-Bold="false">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle HorizontalAlign="Center" Width="100px" />
                                            <ItemTemplate>
                                                <asp:Label ID="Label1" runat="server" Text='<%# (Eval("ACTUAL_PROGRESS")== "N/A")?"N/A":Eval("ACTUAL_PROGRESS")+ "%"  %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="PFTOT" />
                                        <asp:BoundField DataField="FVRTOT" />
                                        <asp:BoundField DataField="CCTOT" />
                                        <asp:BoundField DataField="FACTOT" />
                                        <asp:BoundField DataField="BFTOT" />
                                        <asp:BoundField DataField="CTTOT" />
                                        <asp:BoundField DataField="PF" />
                                        <asp:BoundField DataField="FVR" />
                                        <asp:BoundField DataField="CC" />
                                        <asp:BoundField DataField="FAC" />
                                        <asp:BoundField DataField="BF" />
                                        <asp:BoundField DataField="CT" />
                                        <asp:BoundField DataField="PLANNED" />
                                        <asp:BoundField DataField="TOTALAPP" />
                                        <asp:BoundField DataField="TOTPLAN" />
