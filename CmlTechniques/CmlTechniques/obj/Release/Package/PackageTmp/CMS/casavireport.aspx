<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casavireport.aspx.cs" Inherits="CmlTechniques.CMS.casavireport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:1952px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <div style="position:relative;float:left;width:1952px">
            ...
            <asp:TemplateField>
            <ItemTemplate>
            <table id="inner_table" width="1952px">
            <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
            <td style="width:50px">
            ...
            <td style="font-weight: bold;width:1952px" align="left">
