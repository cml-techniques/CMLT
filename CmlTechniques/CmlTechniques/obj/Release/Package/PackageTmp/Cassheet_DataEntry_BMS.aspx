<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cassheet_DataEntry_BMS.aspx.cs" Inherits="CmlTechniques.Cassheet_DataEntry_BMS" %>
...
<body>
    ...
    <div style="font-family: verdana; font-size: x-small; height: 100%; position: fixed;
                    ...
                    <td id="td0" runat="server">
                        <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                            <ContentTemplate>
                             ...
                             <asp:DropDownList ID="drdes" runat="server" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="drdes_SelectedIndexChanged" style="display:none">
                                </asp:DropDownList>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
            ...
            <asp:Label ID="lbSys_Name" runat="server" Text='<%# Eval("Sys_Name") %>' Width="300px"></asp:Label>
                <asp:Label ID="lbSys_Id" runat="server" Text='<%# Eval("Sys_Id") %>' style="display:none"></asp:Label>
                    ...
                    <ItemStyle Width="6%"  />
                                                                ...
                                                                <asp:BoundField DataField="P_P_to" HeaderText="Provides Power To" ItemStyle-Width="7%">
                                                                    <ItemStyle Width="7%" HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="Substation" HeaderText="Substation" ItemStyle-Width="7%">
                                                                    <ItemStyle Width="7%" HorizontalAlign="Center" />
                                                                </asp:BoundField>
                                                                 <asp:BoundField DataField="Des" HeaderText="Substation" ItemStyle-Width="7%">
                                                                    <ItemStyle Width="7%" HorizontalAlign="Center" />
                                                                </asp:BoundField>
        ...
        <asp:Panel ID="pnlPopup" runat="server" Width="500px" Style="padding: 15px; background-color: #83C8EE;display:none;">
            <div>
                        ...
                        <div>
                            <table style="width: 500px; background-color: White;">
                                <tr>
                                    ...
                                    <td width="350px">
                                        <asp:TextBox ID="upreff" runat="server" Width="350px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="150px">
                                ...
                                <tr id="tr1" runat="server">
                                    ...
                                    <td>
                                        <asp:TextBox ID="uploc" runat="server" Width="350px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr id="tr2" runat="server">
                                    ...
                                    <td>
                                        <asp:TextBox ID="uplb3" runat="server" Width="350px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr id="tr3" runat="server">
                                    ...
                                    <td>
                                        <asp:TextBox ID="uplb1" runat="server" Width="350px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr id="tr4" runat="server">
                                    ...
                                    <td>
                                        <asp:TextBox ID="uplb2" runat="server" Width="350px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr id="tr0" runat="server">
                                    ...
                                    <td>
                                        <asp:TextBox ID="updescr" runat="server" Width="350px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr id="tr5" runat="server">
                                    ...
                                    <td>
                                        <asp:TextBox ID="uplb4" runat="server" Width="350px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="150px">
        ...
        <asp:ModalPopupExtender ID="btnDummy_ModalPopupExtender1" runat="server" TargetControlID="btnDummy1"
            PopupControlID="pnlPopup1" BackgroundCssClass="model-background">
        </asp:ModalPopupExtender>
    </div>
    </form>
</body>
