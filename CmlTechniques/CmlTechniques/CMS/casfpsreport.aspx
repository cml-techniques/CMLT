<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casfpsreport.aspx.cs" Inherits="CmlTechniques.CMS.casfpsreport" %>
    ...
    <div style="font-family: verdana; font-size: xx-small">
       ...
       <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;width:100%;height:26px">
        ...
        <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel></td>
        <td style="font-weight: bold">CAS M8 Fire Protection Services  Commissioning Activity Schedule</td>
        </tr>
        </table>
        <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3082px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" colspan="2">FIRE HOSE REELS</td>
        <td align="center" colspan="2">ZONE CONTROL VALVES</td>
        <td align="center" colspan="2">MONITORED GATE VALVES</td>
        <td align="center" colspan="2">PRESSURE REDUCING STATIONS</td>
        <td align="center" colspan="2">LANDING VALVES</td>
        <td align="center" colspan="2">CHUTE SPRINKLERS</td>
        <td align="center" colspan="2">FIRE HYDRANTS</td>
        <td align="center" colspan="3">ACCEPTANCE</td>
        ...
        <td style="width:100px" align="center">QUANTITY TESTED</td>
        <td style="width:100px" align="center">QUANTITY</td>
        <td style="width:100px" align="center">QUANTITY TESTED</td>
        <td style="width:100px" align="center">QUANTITY</td>
        <td style="width:100px" align="center">QUANTITY TESTED</td>
        ...
        <div>  
            <br />
            <h2 style="margin:0">Summary of Fire Protection Commissioning and Testing</h2>
             <div >
              <asp:UpdatePanel ID="UpdatePanel7" runat="server">
            <ContentTemplate>
             <asp:GridView ID="mygridsumm" runat="server" AutoGenerateColumns="False" onrowdatabound="mygridsumm_RowDataBound" ShowFooter="true">
                ...
                <asp:BoundField DataField="PER_COMPLETED" HeaderText="TOTAL PRE - COMMISSIONED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="PER_COMPLETED1" HeaderText="TESTED" HeaderStyle-Font-Bold="false" > 
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    </asp:BoundField>
