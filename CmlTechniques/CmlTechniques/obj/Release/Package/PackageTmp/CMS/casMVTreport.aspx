<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casMVTreport.aspx.cs" Inherits="CmlTechniques.CMS.casMVTreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text="CAS MISC1 - Horizontal & Vertical Transportation Systems Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2661px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td align="center" colspan="6">LIFE AND SAFETY FUNCTIONAL TESTS</td>
        ...
        <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
        <td align="center" style="width:100px">BUILDING/ ZONE</td>
        <td align="center" style="width:100px">CATEGORY</td>
        <td align="center" style="width:100px">FLOOR LEVEL</td>
        <td align="center" style="width:100px">SEQ. NO</td>
         <td style="width:100px" align="center" >TESTED &amp; COMM</td>
        <td style="width:100px" align="center" >3RD PARTY INSPECTED</td>
        <td style="width:100px" align="center" >EMERGENCY LIGHTING</td>
        <td style="width:100px" align="center"> POWER FAILURE MODE</td>
        <td style="width:100px" align="center" >MONITORING SYSTEM</td>
        <td style="width:100px" align="center" >INTERCOM</td>
        <td style="width:100px" align="center" >BMS / FIRE ALARM INTERFACE</td>
        <td style="width:100px" align="center" >% TEST COMPLETED</td>
 ...
 <ContentTemplate>
   <asp:DropDownList ID="drfed" runat="server" Width="100%" 
        ...
        <div style="position:relative;float:left;width:2661px">
            ...
            <div>
            <br />
            <h2 style="margin:0">Summary of HVTS Commissioning and Testing</h2>
