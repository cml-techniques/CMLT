<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas3Ereport.aspx.cs" Inherits="CmlTechniques.CMS.cas3Ereport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    <form id="form1" runat="server">
     <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.2.5 - Access Control Systems (ACS) Incorporating Intruder Detection System (IDS) Commissioning Activity Schedule</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3332px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center" rowspan="2">POINT TEST COMPLETE</td>
        ...
        <td style="width:100px" align="center" rowspan="2">GRAPHICS TEST</td>
