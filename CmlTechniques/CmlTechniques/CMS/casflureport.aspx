<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casflureport.aspx.cs" Inherits="CmlTechniques.CMS.casflureport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small;width:100%">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2667px;height:80px" cellspacing="1" border="0" id="headTbl">
