<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casUPSCreport.aspx.cs" Inherits="CmlTechniques.CMS.casUPSCreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text="CAS E7 Electrical Services- UPS & CHARGER Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2961px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:200px" align="center" rowspan="2">PROVIDE POWER TO</td>
        <td align="center" colspan="6">UPS / CHARGERSET STAND ALONE TESTING</td>
        <td align="center" colspan="3">OUTGOING CIRCUIT TESTING</td>
         <td align="center" colspan="3">SITE OPERATION & FUNCTION</td>
        ...
        <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
        <td align="center" class="style2">BUILDING/ ZONE</td>
        <td align="center" class="style2">CATEGORY</td>
        <td align="center" class="style2">FLOOR LEVEL</td>
        <td align="center" class="style2">SEQ. NO</td>
        <td align="center" class="style2">PRE-COM TORQUE TEST</td>
        <td align="center" class="style2" >LOAD BANK TESTS</td>
        <td align="center" class="style2" >UPS/CHARGER FUNCTIONAL TEST</td>
        <td align="center" class="style2" >UPS/CHARGER TEST COMPLETE</td>
        <td align="center" class="style2" >CONSULTANT ACCEPTED</td>
        <td align="center" class="style2" >TEST SHEETS FILED</td>
        <td align="center" class="style2" >COLD CABLE TESTS</td>
        <td align="center" class="style2" >CONSULTANT ACCEPTED</td>
        <td align="center" class="style2" >TEST SHEETS FILED</td>
        <td align="center" class="style2" >SITE OPERATION &amp; FUNCTION</td>
        <td align="center" class="style2" >CONSULTANT ACCEPTED</td>
        <td align="center" class="style2" >TEST SHEETS FILED</td>
        </tr>
        <tr bgcolor="#092443">
        ...
        <div style="position:relative;float:left;width:2961px">
            ...
            <div>
            <br />
            <h2 style="margin:0">Summary of U System Commissioning Testing</h2>
            ...
            <ContentTemplate>
                ...
                <asp:TemplateField HeaderText="STAND ALONE TESTING" HeaderStyle-Font-Bold="false">
                 ...
                 <asp:TemplateField HeaderText="OUT GOING CIRCUIT TESTING" HeaderStyle-Font-Bold="false">
                    ...
                    <asp:TemplateField HeaderText="SITE OPERATION & FUNCTION" HeaderStyle-Font-Bold="false">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate >
