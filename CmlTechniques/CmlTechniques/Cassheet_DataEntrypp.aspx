<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cassheet_DataEntrypp.aspx.cs" Inherits="CmlTechniques.Cassheet_DataEntrypp" %>
    ...
    <div style="font-family: verdana; font-size: x-small;height:100%;position:fixed;width:100%">
       ...
       <tr  style="background-image: url('images/head_bg.png'); background-repeat: repeat-x;">
        ...
        <%--<div class="accordion-inner" style="display: none;">--%>
                ...
                <asp:BoundField DataField="Substation" HeaderText="Substation" Visible="false"
                        ItemStyle-Width="9%">
                    <ItemStyle Width="9%" HorizontalAlign="Center" />
                    </asp:BoundField>
