<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casmvhvreport.aspx.cs" Inherits="CmlTechniques.CMS.casmvhvreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3800px;height:80px" border="0" id="headTbl">
        ...
        <td align="center" colspan="6">22/11KV HV CABLE TEST</td>
        <td style="width:100px" align="center" rowspan="2">CONSULTANT ACCEPTED</td>
        <td style="width:100px" align="center" rowspan="2">TESTSHEET FILED</td>
        ...
        <td style="width:100px" align="center">NUMBER OF CABLES</td>
        <td style="width:100px" align="center">CABLE IR AND HI POT</td>
        <td style="width:100px" align="center">TERMINATION TORQUE TEST</td>
        <td style="width:100px" align="center">CABLE TEST COMPLETE</td>
        <td style="width:100px" align="center">CONSULTANT ACCEPTED</td>
        ...
        <td><asp:UpdatePanel ID="UpdatePanel16" runat="server">
             <ContentTemplate>
             <asp:Button ID="btnexpand" runat="server" Text="Expand All" onclick="btnexpand_Click" Width="100%" ForeColor="Red" Font-Size="X-Small" style="cursor:pointer" />
             </ContentTemplate>
             </asp:UpdatePanel></td>
        <td><asp:UpdatePanel ID="UpdatePanel17" runat="server">
             <ContentTemplate>
             <asp:Button ID="btncollapse" runat="server" Text="Collapse All"  ForeColor="Red" Font-Size="X-Small" Width="100%" style="cursor:pointer" onclick="btncollapse_Click" />
             </ContentTemplate>
             </asp:UpdatePanel></td>
        <td>
        ...
        <td style="width:200px" align="center">
            <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                <ContentTemplate>
                <asp:DropDownList ID="drloc" runat="server" Width="100%" AutoPostBack="true" onselectedindexchanged="drloc_SelectedIndexChanged"  > </asp:DropDownList>
                </ContentTemplate>
                </asp:UpdatePanel>
         </td>
        <td style="width:100px" align="center">
            ...
            <ContentTemplate>
            <asp:DropDownList ID="drfed" runat="server" Width="100%" OnSelectedIndexChanged="drfed_SelectedIndexChanged" AutoPostBack="true"  > </asp:DropDownList>
            </ContentTemplate>
            </asp:UpdatePanel>
        </td>
        <td style="width:2900px" align="center" colspan="27"></td>
        </tr>
        </table>
        </div>
        
        <div id="DataDiv" style="overflow: scroll; background-color:#FFF; width:3800px;" onscroll="Onscrollfnction();">
        <div style="width:3800px;">
            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
            <ContentTemplate>
            <asp:GridView ID="mymaster" runat="server" AutoGenerateColumns="False" Width="3800px" onrowdatabound="mymaster_RowDataBound"  Font-Names="Verdana"  Font-Size="X-Small" ShowHeader="False" GridLines="None" >
            <Columns>
            <asp:TemplateField>
            <ItemTemplate>
            <table id="inner_table" width="3800px">
            <tr style="background-image: url('../images/head_bg.png'); background-repeat: repeat-x;">
            <td style="width:30px;"><asp:Button ID="Button1" runat="server" Text="-" CommandArgument = "Button1"  OnClick = "Button1_Click" Width="30px" style="cursor:pointer" /> </td>
            <td style="font-weight: bold;" align="left" colspan="34">
                <asp:Label ID="lbSys_Name" runat="server" Text='<%# Eval("Sys_Name") %>'></asp:Label>
                <asp:Label ID="lbSys_Id" runat="server" Text='<%# Eval("Sys_Id") %>' style="display:none"></asp:Label>
            </td>
            </tr>
            <tr>
            <td colspan="2">
             <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" OnRowDataBound="mydetails_RowDataBound"
                Font-Names="Verdana" Font-Size="X-Small" ShowHeader="false" Width="3800px">
                <Columns>
                <asp:BoundField ><ItemStyle Width="100px" HorizontalAlign="Center" /></asp:BoundField>
                <asp:BoundField DataField ="E_b_ref" ><ItemStyle Width="100px" HorizontalAlign="Center" /></asp:BoundField>
                <asp:BoundField DataField="B_Z" > <ItemStyle Width="100px" HorizontalAlign="Center" /> </asp:BoundField>    
                <asp:BoundField DataField="cat" > <ItemStyle Width="100px" HorizontalAlign="Center" /> </asp:BoundField>
                <asp:BoundField DataField="F_lvl"  > <ItemStyle Width="100px" HorizontalAlign="Center" /> </asp:BoundField>
                <asp:BoundField DataField="Seq_No" > <ItemStyle Width="100px" HorizontalAlign="Center" /> </asp:BoundField>
                <asp:BoundField DataField="Loc" > <ItemStyle Width="200px" HorizontalAlign="Center" /> </asp:BoundField>
                <asp:BoundField DataField="F_from"> <ItemStyle Width="100px" HorizontalAlign="Center" /> </asp:BoundField>
                <asp:BoundField DataField="P_P_to"  > <ItemStyle Width="100px" HorizontalAlign="Center" /> </asp:BoundField>
                <asp:BoundField DataField="Substation"> <ItemStyle Width="100px" HorizontalAlign="Center" /> </asp:BoundField>   
        ...
        <div >
            ...
            <asp:BoundField DataField ="QTY" HeaderText="QUANTITY" HeaderStyle-Font-Bold="false" > 
             ...
             <asp:BoundField DataField="PER_COMPLETED" HeaderText="PANEL" HeaderStyle-Font-Bold="false" ItemStyle-HorizontalAlign="Center"/>
             <asp:BoundField DataField="PER_COMPLETED2" HeaderText="CABLE" HeaderStyle-Font-Bold="false" ItemStyle-HorizontalAlign="Center"/> 
             ...
             <asp:BoundField DataField ="PER_COMPLETED" HeaderText="PANEL" HeaderStyle-Font-Bold="false" > 
              ...
              <asp:BoundField DataField="TOTAL" HeaderText="OVERALL PROGRESS" HeaderStyle-Font-Bold="false" ItemStyle-HorizontalAlign="Center"/>           
