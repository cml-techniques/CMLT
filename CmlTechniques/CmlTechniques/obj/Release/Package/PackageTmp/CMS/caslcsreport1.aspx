<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="caslcsreport1.aspx.cs" Inherits="CmlTechniques.CMS.caslcsreport1" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
      ...
      <div style="background-color:#092443;color:White;font-weight:bold;font-size:small;width:100%;height:26px">
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2355px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:100px" align="center">NO.OF LIGHTING CIRCUITS TESTED</td>
        <td style="width:100px" align="center">NO.OF LIGHTING SCENES</td>
        <td style="width:100px" align="center">ADDRESSING/ PROGRAMMING TEST</td>
        <td style="width:100px" align="center">PC HEADEND/ INTERFACE TEST</td>
