<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cas3Hreport.aspx.cs" Inherits="CmlTechniques.CMS.cas3Hreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">6.2.6 - Closed Circuit Television (CCTV) Commissioning Activity Schedule</td>
                    </tr>
                </table>
                <asp:Label ID="lblprj" runat="server" Text="" style="display:none"></asp:Label>
        </div>
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:3229px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:200px" align="center" rowspan="2">AREA MONITORED</td>
        <td style="width:100px" align="center" rowspan="2">NO.OF POINTS/ CAMERAS</td>
        ...
        <td style="width:100px" align="center" rowspan="2">CCTV VIEW LOCALLY</td>
        <td style="width:100px" align="center" rowspan="2">HEAD END TEST / VIDEO</td>
        <td style="width:100px" align="center" rowspan="2">HEAD END TEST/ CAMERAS &amp; PTZ 
            CONTROL</td>
        <td style="width:100px" align="center" rowspan="2">UPS/ BATTERY SUPPLY TEST</td>
        <td style="width:100px" align="center" rowspan="2">NO.OF INTEGRATION/ INTERFACE TEST</td>
