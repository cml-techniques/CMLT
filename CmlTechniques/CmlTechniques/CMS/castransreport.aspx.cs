...
{
    public partial class castransreport : System.Web.UI.Page
    {
        [Serializable]
        ...
        private void Load_Master()
        {
            ...
            if (lblprj.Text == "11784" && (Request.QueryString["sch"] != null))
            {
                ...
                if (Request.QueryString["sch"].ToString() == "26")
                {
        ...
        protected void mygridsumm_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                e.Row.Cells[0].Text = (e.Row.DataItemIndex + 1).ToString();
                Label _lbl = (Label)e.Row.FindControl("lblpercom");
                ...
                if (Convert.ToDecimal(e.Row.Cells[10].Text) < 0)
                    _lbl.Text = "N/A";
                if(lblprj.Text=="ASAO")
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                if (lblprj.Text == "ASAO")
                {
                    e.Row.Cells[5].Text = Decimal.Round(_tested1,0,MidpointRounding.AwayFromZero).ToString();
                    e.Row.Cells[6].Text = "N/A";
                    e.Row.Cells[7].Text = Decimal.Round(_tested2,0,MidpointRounding.AwayFromZero).ToString();
                }
                else
                {
                    if (_tested1 == _count * -1)
                ...
                if (lblprj.Text == "ASAO")
                    e.Row.Cells[8].Text = (Decimal.Round((_sumry / _qty), 0, MidpointRounding.AwayFromZero)).ToString() + '%';
                else
                {
                    decimal _gtotal =(_total / _count);
                    if (_gtotal >= 99.5m && _gtotal < 100m) _gtotal = 99;
                    e.Row.Cells[8].Text = (Decimal.Round(_gtotal, MidpointRounding.AwayFromZero)).ToString() + '%';
                }
            }
        }
           ...
           if (lblprj.Text == "11784" && (Request.QueryString["sch"] != null))
            {
             ...
             _path = "Cas_Report.aspx?id=3_P" + lblprj.Text + "_B" + drbuilding.SelectedItem.Value + "_F" + drflevel.SelectedItem.Value + "_C" + drcategory.SelectedItem.Value + "_D" + drfed.SelectedItem.Value + "_Z1" + "&Div=" + lbldiv.Text;
