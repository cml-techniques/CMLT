<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casavireport_HMIM.aspx.cs" Inherits="CmlTechniques.CMS.casavireport_HMIM" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
    ...
    <div style="font-family: verdana; font-size: xx-small">
        ...
        <table >
         ...
         <asp:Button ID="btnreset" runat="server" Text="Clear Filter" 
                    ...
                    ForeColor="Red" onclick="btnreset_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lbltitle" runat="server" Text="CAS ELV8 Audio-Visual Intercom Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
        ...
        <div id="HeaderDiv">
        <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2152px;height:80px" cellspacing="1" border="0" id="headTbl">
