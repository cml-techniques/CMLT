...
{
    public partial class casfdreport2 : System.Web.UI.Page
    {
        ...
        protected void mygridsumm_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.Header)
            {
                if (lblprj.Text == "ASAO" || lblprj.Text == "ASAO1")
                {
                    ...
                    e.Row.Cells[5].Text = "ENGINEER ACCEPTED";
                }
            }
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                if (lblprj.Text == "ASAO" || lblprj.Text == "ASAO1")
                {
                    e.Row.Cells[5].Text = (Decimal.Round(_tested2)).ToString();
        ...
        protected void print_Click(object sender, EventArgs e)
        {
            ...
            Insert_Summary();
            string _path = "Cas_Report.aspx?id=9_P" + lblprj.Text + "_B" + drbuilding.SelectedItem.Value + "_F" + drflevel.SelectedItem.Value + "_C" + drcategory.SelectedItem.Value + "_D" + drfed.SelectedItem.Value + "_Z" + (string)Session["zero"] + "&Div=" + lbldiv.Text;
