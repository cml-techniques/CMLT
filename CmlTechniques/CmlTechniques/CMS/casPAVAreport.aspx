<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="casPAVAreport.aspx.cs" Inherits="CmlTechniques.CMS.casPAVAreport" %>
...
<body onload="javascript:ResizeWidth();" style="background-color:#E9E9E9">
         ...
         <asp:Button ID="print" runat="server" Text="Print Report" 
                    ...
                    ForeColor="Red" onclick="print_Click" /></ContentTemplate></asp:UpdatePanel>
                        ...
                        <td style="font-weight: bold">
                            <asp:Label ID="lblhead" runat="server" Text="CAS ELV8  -PAVA Commissioning Activity Schedule"></asp:Label></td>
                    </tr>
                </table>
   ...
   <table style="font-family: Verdana;font-size:x-small;background-color:#9EB6CE;width:2700px;height:80px" cellspacing="1" border="0" id="headTbl">
        ...
        <td style="width:200px" align="center" rowspan="2">AREAS COVERED</td>
        <td style="width:200px" align="center" rowspan="2">FED FROM</td>
        <td style="width:150px" align="center" rowspan="2">PLANNED COMPLETION DATE</td>
        <td style="width:150px" align="center" rowspan="2">CONTINUITY / IR TEST</td>
        <td style="width:150px" align="center" rowspan="2">DB LEVELS</td>
        <td style="width:150px" align="center" rowspan="2">PAGING MIC</td>
        <td style="width:150px" align="center" rowspan="2">ADDRESSING / SOFTWARE TEST</td>
        <td style="width:150px" align="center" rowspan="2">% TEST COMPLETE</td>
        ...
        <div style="position:relative;float:left;width:2700px">
            ...
            <td colspan="2">
              <asp:GridView ID="mydetails" runat="server" AutoGenerateColumns="False" 
                ...
                <asp:BoundField DataField="Loc" >
                    ...
                    <ItemTemplate >
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("per_com5")+ "%"  %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
        ...
        <div >
            ...
            <br />
           <h2 style="margin:0">Summary of PAVA System Testing </h2>
            <div>
            <div >
